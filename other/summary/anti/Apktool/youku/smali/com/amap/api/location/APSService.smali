...
.method public onBind(Landroid/content/Intent;)Landroid/os/IBinder;
    ...
    :try_start_0
    iget-object v0, p0, Lcom/amap/api/location/APSService;->a:Lc8/kUc;

    invoke-interface {v0, p1}, Lc8/kUc;->onBind(Landroid/content/Intent;)Landroid/os/IBinder;
    :try_end_0
...
.method public onCreate(Landroid/content/Context;)V
    ...
    :try_start_0
    invoke-static {p1}, Lc8/rFd;->d(Landroid/content/Context;)Z
    ...
    check-cast v0, Lc8/kUc;

    iput-object v0, p0, Lcom/amap/api/location/APSService;->a:Lc8/kUc;
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
    ...
    new-instance v0, Lc8/AFd;

    invoke-direct {v0, p1}, Lc8/AFd;-><init>(Landroid/content/Context;)V
    ...
    invoke-interface {v0}, Lc8/kUc;->onCreate()V
    :try_end_1
...
.method public onDestroy()V
    ...
    invoke-interface {v0}, Lc8/kUc;->onDestroy()V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method public onStartCommand(Landroid/content/Intent;II)I
    ...
    invoke-interface {v0, p1, p2, p3}, Lc8/kUc;->onStartCommand(Landroid/content/Intent;II)I
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
