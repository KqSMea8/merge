...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0}, Lc8/UVb;-><init>()V
...
.method private getBucket(D)Lc8/VVb;
    .locals 3
    .param p1, "value"    # D
    ...
    check-cast v1, Lc8/VVb;

    invoke-static {p1, p2}, Ljava/lang/Double;->valueOf(D)Ljava/lang/Double;

    move-result-object v2

    invoke-virtual {v1, v2}, Lc8/VVb;->in(Ljava/lang/Double;)Z
...
.method public declared-synchronized getBuckets()Ljava/util/Map;
    ...
    check-cast v0, Lc8/VVb;

    .line 190
    .local v0, "b":Lc8/VVb;
    invoke-static {v0}, Lc8/VVb;->access$000(Lc8/VVb;)J
    ...
    invoke-static {v0}, Lc8/VVb;->access$100(Lc8/VVb;)Ljava/lang/Double;
    ...
    invoke-static {v0}, Lc8/VVb;->access$200(Lc8/VVb;)Ljava/lang/Double;
...
.method public declared-synchronized merge(Lcom/alibaba/mtl/appmonitor/model/MeasureValue;)V
    ...
    invoke-direct {p0, v2, v3}, Lcom/alibaba/mtl/appmonitor/model/MeasureValue;->getBucket(D)Lc8/VVb;

    move-result-object v0

    .line 104
    .local v0, "bucket":Lc8/VVb;
    if-eqz v0, :cond_0

    .line 105
    invoke-virtual {v0}, Lc8/VVb;->increase()V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method protected declared-synchronized setBuckets(Lcom/alibaba/mtl/appmonitor/model/Measure;)V
    ...
    invoke-direct {v6, p0, v3, v4}, Lc8/VVb;-><init>(Lcom/alibaba/mtl/appmonitor/model/MeasureValue;Ljava/lang/Double;Ljava/lang/Double;)V
    ...
    invoke-direct {p0, v4, v5}, Lcom/alibaba/mtl/appmonitor/model/MeasureValue;->getBucket(D)Lc8/VVb;

    move-result-object v1

    .line 213
    .local v1, "bucket":Lc8/VVb;
    if-eqz v1, :cond_0

    .line 214
    invoke-virtual {v1}, Lc8/VVb;->increase()V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
