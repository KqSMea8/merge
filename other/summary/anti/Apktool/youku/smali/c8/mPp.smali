...
.method public static getCallbackExecutorServices()[Ljava/util/concurrent/ExecutorService;
    ...
    .line 91
    sget-object v1, Lc8/mPp;->callbackExecutors:[Ljava/util/concurrent/ExecutorService;

    if-nez v1, :cond_1

    .line 92
    const-class v2, Lc8/mPp;
    ...
    sput-object v1, Lc8/mPp;->callbackExecutors:[Ljava/util/concurrent/ExecutorService;
    ...
    new-instance v7, Lc8/lPp;

    sget v8, Lc8/mPp;->priority:I
    ...
    invoke-direct {v7, v8, v9}, Lc8/lPp;-><init>(ILjava/lang/String;)V

    invoke-static {v3, v4, v5, v6, v7}, Lc8/mPp;->createExecutor(IIIILjava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ThreadPoolExecutor;
...
.method public static getDefaultThreadPoolExecutor()Ljava/util/concurrent/ThreadPoolExecutor;
    ...
    .prologue
    .line 69
    sget-object v0, Lc8/mPp;->threadPoolExecutor:Ljava/util/concurrent/ThreadPoolExecutor;

    if-nez v0, :cond_1

    .line 70
    const-class v1, Lc8/mPp;
    ...
    new-instance v5, Lc8/lPp;

    sget v6, Lc8/mPp;->priority:I

    invoke-direct {v5, v6}, Lc8/lPp;-><init>(I)V

    invoke-static {v0, v2, v3, v4, v5}, Lc8/mPp;->createExecutor(IIIILjava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ThreadPoolExecutor;

    move-result-object v0

    sput-object v0, Lc8/mPp;->threadPoolExecutor:Ljava/util/concurrent/ThreadPoolExecutor;
...
.method public static getRequestThreadPoolExecutor()Ljava/util/concurrent/ThreadPoolExecutor;
    ...
    .prologue
    .line 80
    sget-object v0, Lc8/mPp;->requestExecutor:Ljava/util/concurrent/ThreadPoolExecutor;
    ...
    invoke-direct {v5, v6, v7}, Lc8/lPp;-><init>(ILjava/lang/String;)V

    invoke-static {v0, v2, v3, v4, v5}, Lc8/mPp;->createExecutor(IIIILjava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ThreadPoolExecutor;

    move-result-object v0

    sput-object v0, Lc8/mPp;->requestExecutor:Ljava/util/concurrent/ThreadPoolExecutor;
...
.method public static setCallbackExecutorServices([Ljava/util/concurrent/ExecutorService;)V
    ...
    .line 116
    sput-object p0, Lc8/mPp;->callbackExecutors:[Ljava/util/concurrent/ExecutorService;
...
.method public static setDefaultThreadPoolExecutor(Ljava/util/concurrent/ThreadPoolExecutor;)V
    ...
    .line 107
    sput-object p0, Lc8/mPp;->threadPoolExecutor:Ljava/util/concurrent/ThreadPoolExecutor;
...
.method public static setRequestThreadPoolExecutor(Ljava/util/concurrent/ThreadPoolExecutor;)V
    ...
    .line 122
    sput-object p0, Lc8/mPp;->requestExecutor:Ljava/util/concurrent/ThreadPoolExecutor;
...
.method public static submit(Ljava/lang/Runnable;)Ljava/util/concurrent/Future;
    ...
    :try_start_0
    invoke-static {}, Lc8/mPp;->getDefaultThreadPoolExecutor()Ljava/util/concurrent/ThreadPoolExecutor;
...
.method public static submitCallbackTask(ILjava/lang/Runnable;)Ljava/util/concurrent/Future;
    ...
    .local v1, "future":Ljava/util/concurrent/Future;, "Ljava/util/concurrent/Future<*>;"
    :try_start_0
    invoke-static {}, Lc8/mPp;->getCallbackExecutorServices()[Ljava/util/concurrent/ExecutorService;
