...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lc8/SDb;->init:Z
    ...
    sput-object v0, Lc8/SDb;->mFutureMap:Ljava/util/HashMap;
...
.method private constructor <init>(II)V
    ...
    iput v0, p0, Lc8/SDb;->interval:I

    .line 102
    iput p1, p0, Lc8/SDb;->eventId:I

    .line 103
    iput p2, p0, Lc8/SDb;->interval:I
    ...
    iput-wide v0, p0, Lc8/SDb;->startTime:J
...
.method static destroy()V
    ...
    .prologue
    .line 57
    sget-object v3, Lc8/SDb;->mFutureMap:Ljava/util/HashMap;
    ...
    sput-boolean v3, Lc8/SDb;->init:Z

    .line 65
    const/4 v3, 0x0

    sput-object v3, Lc8/SDb;->uploadTasks:Ljava/util/Map;
...
.method static init()V
    ...
    .line 37
    sget-boolean v9, Lc8/SDb;->init:Z
    ...
    sput-object v9, Lc8/SDb;->uploadTasks:Ljava/util/Map;
    ...
    .line 45
    .local v6, "interval":I
    new-instance v8, Lc8/SDb;

    mul-int/lit16 v9, v6, 0x3e8

    invoke-direct {v8, v1, v9}, Lc8/SDb;-><init>(II)V

    .line 46
    .local v8, "uploadTask":Lc8/SDb;
    sget-object v9, Lc8/SDb;->uploadTasks:Ljava/util/Map;
    ...
    .line 47
    sget-object v9, Lc8/SDb;->mFutureMap:Ljava/util/HashMap;
    ...
    iget v10, v8, Lc8/SDb;->interval:I

    int-to-long v10, v10

    invoke-virtual {v9, v4, v8, v10, v11}, Lc8/eCb;->schedule(Ljava/util/concurrent/ScheduledFuture;Ljava/lang/Runnable;J)Ljava/util/concurrent/ScheduledFuture;
    ...
    .end local v8    # "uploadTask":Lc8/SDb;
    :cond_0
    ...
    :cond_1
    sput-boolean v13, Lc8/SDb;->init:Z
...
.method static setStatisticsInterval(II)V
    .locals 12
    .param p0, "eventId"    # I
    ...
    .prologue
    .line 70
    sget-object v7, Lc8/SDb;->uploadTasks:Ljava/util/Map;

    monitor-enter v7

    .line 71
    :try_start_0
    sget-object v6, Lc8/SDb;->uploadTasks:Ljava/util/Map;
    ...
    check-cast v3, Lc8/SDb;

    .line 72
    .local v3, "uploadTask":Lc8/SDb;
    if-nez v3, :cond_1
    ...
    .line 74
    new-instance v3, Lc8/SDb;

    .end local v3    # "uploadTask":Lc8/SDb;
    mul-int/lit16 v6, p1, 0x3e8

    invoke-direct {v3, p0, v6}, Lc8/SDb;-><init>(II)V

    .line 75
    .restart local v3    # "uploadTask":Lc8/SDb;
    sget-object v6, Lc8/SDb;->uploadTasks:Ljava/util/Map;
    ...
    .line 76
    sget-object v6, Lc8/SDb;->mFutureMap:Ljava/util/HashMap;
    ...
    iget v8, v3, Lc8/SDb;->interval:I

    int-to-long v8, v8

    invoke-virtual {v6, v2, v3, v8, v9}, Lc8/eCb;->schedule(Ljava/util/concurrent/ScheduledFuture;Ljava/lang/Runnable;J)Ljava/util/concurrent/ScheduledFuture;
    ...
    iget-wide v10, v3, Lc8/SDb;->startTime:J
    ...
    invoke-virtual {v6, v2, v3, v4, v5}, Lc8/eCb;->schedule(Ljava/util/concurrent/ScheduledFuture;Ljava/lang/Runnable;J)Ljava/util/concurrent/ScheduledFuture;
    ...
    .line 92
    iput-wide v0, v3, Lc8/SDb;->startTime:J
...
.method static uploadAllEvent()V
    .locals 6
    ...
    invoke-virtual {v4, v5}, Lc8/aEb;->uploadEvent(I)V
...
.method public run()V
    ...
    iget v2, p0, Lc8/SDb;->eventId:I

    invoke-virtual {v1, v2}, Lc8/aEb;->uploadEvent(I)V

    .line 111
    sget-object v1, Lc8/SDb;->uploadTasks:Ljava/util/Map;
    ...
    iput-wide v2, p0, Lc8/SDb;->startTime:J

    .line 113
    sget-object v1, Lc8/SDb;->mFutureMap:Ljava/util/HashMap;
    ...
    iget v2, p0, Lc8/SDb;->interval:I

    int-to-long v2, v2

    invoke-virtual {v1, v0, p0, v2, v3}, Lc8/eCb;->schedule(Ljava/util/concurrent/ScheduledFuture;Ljava/lang/Runnable;J)Ljava/util/concurrent/ScheduledFuture;
