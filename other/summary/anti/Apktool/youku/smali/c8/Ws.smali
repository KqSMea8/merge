...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput v2, p0, Lc8/Ws;->mLastWidthSize:I

    .line 54
    invoke-virtual {p0}, Lc8/Ws;->getResources()Landroid/content/res/Resources;

    move-result-object v2

    invoke-static {v2}, Lc8/Zi;->getScreenHeightDp(Landroid/content/res/Resources;)I
    ...
    :goto_0
    sget-object v2, Lcom/youku/phone/R$styleable;->ButtonBarLayout:[I
    ...
    sget v2, Lcom/youku/phone/R$styleable;->ButtonBarLayout_allowStacking:I

    invoke-virtual {v1, v2, v0}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v2

    iput-boolean v2, p0, Lc8/Ws;->mAllowStacking:Z
...
.method private getNextVisibleChildIndex(I)I
    ...
    .local v1, "i":I
    invoke-virtual {p0}, Lc8/Ws;->getChildCount()I
    ...
    .line 158
    invoke-virtual {p0, v1}, Lc8/Ws;->getChildAt(I)Landroid/view/View;
...
.method private isStacked()Z
    ...
    .line 183
    invoke-virtual {p0}, Lc8/Ws;->getOrientation()I
...
.method private setStacked(Z)V
    ...
    :goto_0
    invoke-virtual {p0, v3}, Lc8/Ws;->setOrientation(I)V
    ...
    :goto_1
    invoke-virtual {p0, v3}, Lc8/Ws;->setGravity(I)V

    .line 169
    sget v3, Lcom/youku/phone/R$id;->spacer:I

    invoke-virtual {p0, v3}, Lc8/Ws;->findViewById(I)Landroid/view/View;
    ...
    invoke-virtual {p0, v3}, Lc8/Ws;->bringChildToFront(Landroid/view/View;)V
...
.method protected onMeasure(II)V
    ...
    iget-boolean v0, v0, Lc8/Ws;->mAllowStacking:Z
    ...
    iget v0, v0, Lc8/Ws;->mLastWidthSize:I
    ...
    invoke-direct/range {p0 .. p0}, Lc8/Ws;->isStacked()Z
    ...
    invoke-direct {v0, v1}, Lc8/Ws;->setStacked(Z)V

    .line 82
    :cond_0
    move-object/from16 v0, p0

    iput v15, v0, Lc8/Ws;->mLastWidthSize:I
    ...
    invoke-direct {v0, v1}, Lc8/Ws;->getNextVisibleChildIndex(I)I
    ...
    invoke-virtual {v0, v6}, Lc8/Ws;->getChildAt(I)Landroid/view/View;
    ...
    invoke-virtual/range {p0 .. p0}, Lc8/Ws;->getPaddingTop()I
    ...
    invoke-virtual {v0, v13}, Lc8/Ws;->getChildAt(I)Landroid/view/View;
    ...
    .line 144
    invoke-virtual/range {p0 .. p0}, Lc8/Ws;->getResources()Landroid/content/res/Resources;
    ...
    invoke-virtual {v0, v11}, Lc8/Ws;->setMinimumHeight(I)V
    ...
    .local v7, "i":I
    invoke-virtual/range {p0 .. p0}, Lc8/Ws;->getChildCount()I
    ...
    invoke-virtual {v0, v7}, Lc8/Ws;->getChildAt(I)Landroid/view/View;
    ...
    .line 117
    :cond_9
    invoke-virtual/range {p0 .. p0}, Lc8/Ws;->getPaddingLeft()I

    move-result v16

    add-int v16, v16, v2

    invoke-virtual/range {p0 .. p0}, Lc8/Ws;->getPaddingRight()I
    ...
    :cond_b
    invoke-virtual/range {p0 .. p0}, Lc8/Ws;->getPaddingBottom()I
...
.method public setAllowStacking(Z)V
    ...
    .prologue
    .line 63
    iget-boolean v0, p0, Lc8/Ws;->mAllowStacking:Z

    if-eq v0, p1, :cond_1

    .line 64
    iput-boolean p1, p0, Lc8/Ws;->mAllowStacking:Z
    ...
    invoke-direct {p0, v0}, Lc8/Ws;->setStacked(Z)V

    .line 68
    :cond_0
    invoke-virtual {p0}, Lc8/Ws;->requestLayout()V
