...
.method private static checkSdcardDeviceModle()Z
    ...
    :cond_0
    invoke-static {}, Lc8/gWe;->readSdcardDeviceModleFile()Ljava/lang/String;

    move-result-object v1

    .line 111
    .restart local v1    # "content":Ljava/lang/String;
    invoke-static {v1}, Lc8/aWe;->getDecodedContent(Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_0
    invoke-static {v2}, Lc8/mWe;->jsonToMap(Ljava/lang/String;)Ljava/util/Map;

    move-result-object v5

    .line 114
    sput-object v5, Lc8/WVe;->mSdcardDeviceModle:Ljava/util/Map;
    ...
    invoke-static {v5}, Lc8/sVe;->getAndroidID(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 119
    :cond_1
    invoke-static {}, Lc8/WVe;->clearSdcardDeviceModle()V
    :try_end_0
...
.method private static clearSdcardDeviceModle()V
    ...
    .line 97
    :try_start_0
    sget-object v0, Lc8/WVe;->mSdcardDeviceModle:Ljava/util/Map;
    ...
    sput-object v0, Lc8/WVe;->mSdcardDeviceModle:Ljava/util/Map;

    .line 99
    const-string/jumbo v0, ""

    invoke-static {v0}, Lc8/gWe;->writeSdcardDeviceModleFile(Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method private static declared-synchronized getModule(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 86
    :cond_1
    invoke-static {}, Lc8/WVe;->checkSdcardDeviceModle()Z
...
.method public static getModuleImei()Ljava/lang/String;
    ...
    invoke-static {v0}, Lc8/WVe;->getModule(Ljava/lang/String;)Ljava/lang/String;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static declared-synchronized writeSdcardDeviceModle(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 52
    sget-object v4, Lc8/WVe;->mSdcardDeviceModle:Ljava/util/Map;
    ...
    sput-object v4, Lc8/WVe;->mSdcardDeviceModle:Ljava/util/Map;
    ...
    .line 65
    :cond_5
    invoke-static {v2}, Lc8/sVe;->getAndroidID(Landroid/content/Context;)Ljava/lang/String;
    ...
    sget-object v6, Lc8/WVe;->mSdcardDeviceModle:Ljava/util/Map;
    ...
    invoke-static {v3}, Lc8/gWe;->writeSdcardDeviceModleFile(Ljava/lang/String;)V
    :try_end_1
