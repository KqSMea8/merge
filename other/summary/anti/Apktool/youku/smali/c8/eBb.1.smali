...
.field protected mIUploadExcuted:Lc8/XAb;
...
.method public constructor <init>()V
    ...
    iput v0, p0, Lc8/eBb;->mMaxUploadTimes:I

    .line 20
    const/4 v0, 0x0

    iput-object v0, p0, Lc8/eBb;->mIUploadExcuted:Lc8/XAb;
    ...
    iput-object v0, p0, Lc8/eBb;->mAllowedNetworkStatus:Lcom/alibaba/analytics/core/sync/UploadLog$NetworkStatus;
...
# virtual methods
.method protected getNetworkStatus()Lcom/alibaba/analytics/core/sync/UploadLog$NetworkStatus;
    .locals 2
...
.method public parserConfig(Ljava/lang/String;)V
    ...
    invoke-virtual {v10}, Lc8/uzb;->getConfMgr()Lc8/Azb;

    move-result-object v1

    .line 59
    .local v1, "configMgr":Lc8/Azb;
    if-eqz v1, :cond_1
    ...
    .end local v1    # "configMgr":Lc8/Azb;
    ...
    invoke-static {v10, v4, v11}, Lc8/NBb;->e(Ljava/lang/String;Ljava/lang/Throwable;[Ljava/lang/Object;)V
    ...
    .restart local v1    # "configMgr":Lc8/Azb;
    ...
    .line 80
    invoke-virtual {v1, v7, v3}, Lc8/Azb;->updateAndDispatch(Ljava/lang/String;Ljava/util/Map;)V
...
.method public setAllowedNetworkStatus(Lcom/alibaba/analytics/core/sync/UploadLog$NetworkStatus;)V
    ...
    .prologue
    .line 33
    iput-object p1, p0, Lc8/eBb;->mAllowedNetworkStatus:Lcom/alibaba/analytics/core/sync/UploadLog$NetworkStatus;

    .line 34
    return-void
.end method

.method public setIUploadExcuted(Lc8/XAb;)V
    .locals 0
    .param p1, "uploadExcuted"    # Lc8/XAb;

    .prologue
    .line 37
    iput-object p1, p0, Lc8/eBb;->mIUploadExcuted:Lc8/XAb;
...
.method public setUploadTimes(I)V
    ...
    .prologue
    .line 29
    iput p1, p0, Lc8/eBb;->mMaxUploadTimes:I
