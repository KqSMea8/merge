...
.method protected constructor <init>(I)V
    ...
    invoke-direct {p0, p1}, Lc8/cDd;-><init>(I)V

    const/16 v0, 0xa

    new-array v0, v0, [Ljava/lang/String;

    iput-object v0, p0, Lc8/YCd;->c:[Ljava/lang/String;

    iput v1, p0, Lc8/YCd;->d:I

    iput-boolean v1, p0, Lc8/YCd;->e:Z

    iput v1, p0, Lc8/YCd;->f:I
...
.method private d()Ljava/lang/String;
    ...
    iget-object v2, p0, Lc8/YCd;->c:[Ljava/lang/String;
...
.method protected final a(Ljava/util/List;)Ljava/lang/String;
    ...
    :try_start_1
    invoke-virtual {v2}, Lc8/UDd;->close()V
    :try_end_1
    ...
    :cond_3
    new-instance v2, Lc8/UDd;

    sget-object v0, Lc8/VDd;->a:Ljava/nio/charset/Charset;

    invoke-direct {v2, v3, v0}, Lc8/UDd;-><init>(Ljava/io/InputStream;Ljava/nio/charset/Charset;)V
    :try_end_4
    ...
    :goto_3
    :try_start_5
    invoke-virtual {v2}, Lc8/UDd;->a()Ljava/lang/String;
    ...
    :cond_7
    :goto_8
    iget-boolean v0, p0, Lc8/YCd;->e:Z

    if-eqz v0, :cond_12

    invoke-direct {p0}, Lc8/YCd;->d()Ljava/lang/String;
    ...
    iput v0, p0, Lc8/YCd;->d:I

    :cond_9
    iget-object v0, p0, Lc8/YCd;->c:[Ljava/lang/String;

    iget v6, p0, Lc8/YCd;->d:I
    ...
    check-cast v0, Lc8/aGd;

    invoke-virtual {v0}, Lc8/aGd;->f()[Ljava/lang/String;

    move-result-object v7

    invoke-static {v7, v4}, Lc8/YCd;->a([Ljava/lang/String;Ljava/lang/String;)Z

    move-result v7

    iput-boolean v7, p0, Lc8/YCd;->e:Z

    iget-boolean v7, p0, Lc8/YCd;->e:Z

    if-eqz v7, :cond_a

    invoke-virtual {p0, v0}, Lc8/YCd;->a(Lc8/aGd;)V
    ...
    invoke-static {v0, v6, v7}, Lc8/eGd;->a(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    ...
    :try_start_12
    invoke-virtual {v0}, Lc8/UDd;->close()V
    :try_end_12
...
.method protected final a(Landroid/content/Context;)Z
    ...
    invoke-static {p1}, Lc8/TFd;->m(Landroid/content/Context;)I

    move-result v2

    if-ne v2, v0, :cond_2

    sget-boolean v2, Lc8/YCd;->b:Z

    if-eqz v2, :cond_2

    sput-boolean v1, Lc8/YCd;->b:Z
    ...
    :try_start_0
    new-instance v3, Lc8/qDd;

    invoke-direct {v3, p1}, Lc8/qDd;-><init>(Landroid/content/Context;)V

    invoke-virtual {v3}, Lc8/qDd;->a()Lc8/rDd;
    ...
    invoke-virtual {v4, v1}, Lc8/rDd;->c(Z)V

    invoke-virtual {v3, v4}, Lc8/qDd;->a(Lc8/rDd;)V
