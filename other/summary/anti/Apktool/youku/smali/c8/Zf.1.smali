...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lc8/Zf;->installedApk:Ljava/util/Set;
    ...
    invoke-static {v0}, Lc8/Zf;->isVMMultidexCapable(Ljava/lang/String;)Z

    move-result v0

    sput-boolean v0, Lc8/Zf;->IS_VM_MULTIDEX_CAPABLE:Z
...
.method static synthetic access$300(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/reflect/Field;
    ...
    .prologue
    .line 56
    invoke-static {p0, p1}, Lc8/Zf;->findField(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/reflect/Field;
...
.method static synthetic access$400(Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .prologue
    .line 56
    invoke-static {p0, p1, p2}, Lc8/Zf;->expandFieldArray(Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method static synthetic access$500(Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;
    ...
    .prologue
    .line 56
    invoke-static {p0, p1, p2}, Lc8/Zf;->findMethod(Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;
...
.method private static clearOldDexDir(Landroid/content/Context;)V
    ...
    const-string/jumbo v4, "Failed to delete secondary dex dir "
...
.method private static doInstallation(Landroid/content/Context;Ljava/io/File;Ljava/io/File;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 200
    sget-object v4, Lc8/Zf;->installedApk:Ljava/util/Set;

    monitor-enter v4

    .line 201
    :try_start_0
    sget-object v3, Lc8/Zf;->installedApk:Ljava/util/Set;
    ...
    const-string/jumbo v5, "MultiDex is not guaranteed to work in SDK version "
    ...
    const-string/jumbo v5, ": SDK version higher than "
    ...
    const-string/jumbo v5, " should be backed by runtime with built-in multidex capabilty but it\'s not the case here: java.vm.version=\""
    ...
    const-string/jumbo v5, "Context class loader is null. Must be running in test mode. Skip patching."
    ...
    :cond_2
    :try_start_4
    invoke-static {p0}, Lc8/Zf;->clearOldDexDir(Landroid/content/Context;)V
    :try_end_4
    ...
    :goto_1
    :try_start_5
    invoke-static {p0, p2, p3}, Lc8/Zf;->getDexDir(Landroid/content/Context;Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    .line 249
    invoke-static {p0, p1, v0, p4, v3}, Lc8/bg;->load(Landroid/content/Context;Ljava/io/File;Ljava/io/File;Ljava/lang/String;Z)Ljava/util/List;

    move-result-object v1

    .line 250
    .local v1, "files":Ljava/util/List;, "Ljava/util/List<+Ljava/io/File;>;"
    invoke-static {v2, v0, v1}, Lc8/Zf;->installSecondaryDexes(Ljava/lang/ClassLoader;Ljava/io/File;Ljava/util/List;)V
...
.method private static expandFieldArray(Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 393
    invoke-static {v1, p0, v0}, Lcom/ali/mobisecenhance/ReflectMap;->Field_set(Ljava/lang/reflect/Field;Ljava/lang/Object;Ljava/lang/Object;)V
...
.method private static getDexDir(Landroid/content/Context;Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    :try_start_0
    invoke-static {v0}, Lc8/Zf;->mkdirChecked(Ljava/io/File;)V
    :try_end_0
    ...
    invoke-static {v1}, Lc8/Zf;->mkdirChecked(Ljava/io/File;)V
...
.method public static install(Landroid/content/Context;)V
    ...
    .line 95
    sget-boolean v2, Lc8/Zf;->IS_VM_MULTIDEX_CAPABLE:Z
    ...
    :cond_2
    :try_start_0
    invoke-static {p0}, Lc8/Zf;->getApplicationInfo(Landroid/content/Context;)Landroid/content/pm/ApplicationInfo;
    ...
    invoke-static {p0, v2, v3, v4, v5}, Lc8/Zf;->doInstallation(Landroid/content/Context;Ljava/io/File;Ljava/io/File;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
...
.method public static installInstrumentation(Landroid/content/Context;Landroid/content/Context;)V
    ...
    .line 141
    sget-boolean v5, Lc8/Zf;->IS_VM_MULTIDEX_CAPABLE:Z
    ...
    const-string/jumbo v7, "MultiDex installation failed. SDK "
    ...
    const-string/jumbo v7, " is unsupported. Min SDK version is "
    ...
    .line 159
    invoke-static {p1}, Lc8/Zf;->getApplicationInfo(Landroid/content/Context;)Landroid/content/pm/ApplicationInfo;
    ...
    invoke-static {p1, v5, v1, v6, v4}, Lc8/Zf;->doInstallation(Landroid/content/Context;Ljava/io/File;Ljava/io/File;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p1, v5, v1, v6, v7}, Lc8/Zf;->doInstallation(Landroid/content/Context;Ljava/io/File;Ljava/io/File;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .end local v4    # "instrumentationPrefix":Ljava/lang/String;
    :catch_0
    move-exception v2
    ...
    const-string/jumbo v6, "MultiDex installation failure"
    ...
    const-string/jumbo v7, "MultiDex installation failed ("
...
.method private static installSecondaryDexes(Ljava/lang/ClassLoader;Ljava/io/File;Ljava/util/List;)V
    ...
    .line 311
    invoke-static {p0, p2, p1}, Lc8/Xf;->access$000(Ljava/lang/ClassLoader;Ljava/util/List;Ljava/io/File;)V
    ...
    .line 313
    invoke-static {p0, p2, p1}, Lc8/Wf;->access$100(Ljava/lang/ClassLoader;Ljava/util/List;Ljava/io/File;)V

    goto :goto_0

    .line 315
    :cond_2
    invoke-static {p0, p2}, Lc8/Yf;->access$200(Ljava/lang/ClassLoader;Ljava/util/List;)V
