...
.method private static prepareKey(Ljava/lang/String;)Lc8/rWe;
    .locals 9
    ...
    invoke-direct {v3, v5}, Lc8/rWe;-><init>(Lc8/qWe;)V

    .line 34
    .local v3, "lRC4Key":Lc8/rWe;
    const/4 v0, 0x0
    ...
    .line 35
    iget-object v6, v3, Lc8/rWe;->state:[I
    ...
    .line 37
    :cond_0
    iput v7, v3, Lc8/rWe;->x:I

    .line 38
    iput v7, v3, Lc8/rWe;->y:I
    ...
    iget-object v7, v3, Lc8/rWe;->state:[I
...
.method public static rc4([B)[B
    ...
    invoke-static {v1}, Lc8/sWe;->prepareKey(Ljava/lang/String;)Lc8/rWe;

    move-result-object v0

    .line 21
    .local v0, "lRC4Key":Lc8/rWe;
    if-eqz v0, :cond_0

    .line 22
    invoke-static {p0, v0}, Lc8/sWe;->rc4([BLc8/rWe;)[B

    move-result-object v1

    .line 25
    .end local v0    # "lRC4Key":Lc8/rWe;
    :goto_0
    return-object v1
...
.method private static rc4([BLc8/rWe;)[B
    .locals 7
    .param p0, "pData"    # [B
    .param p1, "pKey"    # Lc8/rWe;
    ...
    .line 63
    iget v2, p1, Lc8/rWe;->x:I

    .line 64
    .local v2, "x":I
    iget v4, p1, Lc8/rWe;->y:I
    ...
    .line 69
    iget-object v5, p1, Lc8/rWe;->state:[I
    ...
    iget-object v6, p1, Lc8/rWe;->state:[I
    ...
    :cond_0
    iput v2, p1, Lc8/rWe;->x:I

    .line 78
    iput v4, p1, Lc8/rWe;->y:I
