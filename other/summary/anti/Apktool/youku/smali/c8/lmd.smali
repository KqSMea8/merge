...
.method public constructor <init>(Ljava/lang/Class;)V
    ...
    .prologue
    .local p0, "this":Lc8/lmd;, "Lcom/google/gson/internal/bind/TypeAdapters$EnumTypeAdapter<TT;>;"
    ...
    iput-object v5, p0, Lc8/lmd;->nameToConstant:Ljava/util/Map;
    ...
    iput-object v5, p0, Lc8/lmd;->constantToName:Ljava/util/Map;
    ...
    const-class v10, Lc8/Zjd;

    invoke-virtual {v6, v10}, Ljava/lang/reflect/Field;->getAnnotation(Ljava/lang/Class;)Ljava/lang/annotation/Annotation;

    move-result-object v1

    check-cast v1, Lc8/Zjd;

    .line 781
    .local v1, "annotation":Lc8/Zjd;
    if-eqz v1, :cond_0

    .line 782
    invoke-interface {v1}, Lc8/Zjd;->value()Ljava/lang/String;

    move-result-object v4

    .line 783
    invoke-interface {v1}, Lc8/Zjd;->alternate()[Ljava/lang/String;
    ...
    iget-object v12, p0, Lc8/lmd;->nameToConstant:Ljava/util/Map;
    ...
    :cond_0
    iget-object v6, p0, Lc8/lmd;->nameToConstant:Ljava/util/Map;

    invoke-interface {v6, v4, v2}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 788
    iget-object v6, p0, Lc8/lmd;->constantToName:Ljava/util/Map;
    ...
    .line 790
    .end local v1    # "annotation":Lc8/Zjd;
...
# virtual methods
.method public read(Lc8/qmd;)Ljava/lang/Enum;
    .locals 2
    .param p1, "in"    # Lc8/qmd;
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    :cond_0
    iget-object v0, p0, Lc8/lmd;->nameToConstant:Ljava/util/Map;
...
.method public bridge synthetic read(Lc8/qmd;)Ljava/lang/Object;
    ...
    .line 772
    .local p0, "this":Lc8/lmd;, "Lcom/google/gson/internal/bind/TypeAdapters$EnumTypeAdapter<TT;>;"
    invoke-virtual {p0, p1}, Lc8/lmd;->read(Lc8/qmd;)Ljava/lang/Enum;
...
.method public write(Lc8/smd;Ljava/lang/Enum;)V
    .locals 1
    ...
    .line 803
    :cond_0
    iget-object v0, p0, Lc8/lmd;->constantToName:Ljava/util/Map;
...
.method public bridge synthetic write(Lc8/smd;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lc8/lmd;->write(Lc8/smd;Ljava/lang/Enum;)V
