...
.method constructor <init>()V
    ...
    .prologue
    .line 31
    .local p0, "this":Lc8/zd;, "Landroid/support/design/widget/DirectedAcyclicGraph<TT;>;"
    ...
    iput-object v0, p0, Lc8/zd;->mListPool:Landroid/support/v4/util/Pools$Pool;
    ...
    iput-object v0, p0, Lc8/zd;->mGraph:Landroid/support/v4/util/SimpleArrayMap;
    ...
    iput-object v0, p0, Lc8/zd;->mSortResult:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lc8/zd;->mSortTmpMarked:Ljava/util/HashSet;
...
.method private dfs(Ljava/lang/Object;Ljava/util/ArrayList;Ljava/util/HashSet;)V
    ...
    .line 169
    iget-object v3, p0, Lc8/zd;->mGraph:Landroid/support/v4/util/SimpleArrayMap;
    ...
    invoke-direct {p0, v3, p2, p3}, Lc8/zd;->dfs(Ljava/lang/Object;Ljava/util/ArrayList;Ljava/util/HashSet;)V
...
.method private getEmptyList()Ljava/util/ArrayList;
    ...
    .line 190
    .local p0, "this":Lc8/zd;, "Landroid/support/design/widget/DirectedAcyclicGraph<TT;>;"
    iget-object v1, p0, Lc8/zd;->mListPool:Landroid/support/v4/util/Pools$Pool;
...
.method private poolList(Ljava/util/ArrayList;)V
    ...
    .line 199
    iget-object v0, p0, Lc8/zd;->mListPool:Landroid/support/v4/util/Pools$Pool;
...
.method addEdge(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    iget-object v1, p0, Lc8/zd;->mGraph:Landroid/support/v4/util/SimpleArrayMap;
    ...
    .line 76
    invoke-direct {p0}, Lc8/zd;->getEmptyList()Ljava/util/ArrayList;
...
.method addNode(Ljava/lang/Object;)V
    ...
    .local p0, "this":Lc8/zd;, "Landroid/support/design/widget/DirectedAcyclicGraph<TT;>;"
    .local p1, "node":Ljava/lang/Object;, "TT;"
    iget-object v0, p0, Lc8/zd;->mGraph:Landroid/support/v4/util/SimpleArrayMap;
...
.method clear()V
    ...
    .line 131
    invoke-direct {p0, v0}, Lc8/zd;->poolList(Ljava/util/ArrayList;)V
...
.method getOutgoingEdges(Ljava/lang/Object;)Ljava/util/List;
    ...
    .local v1, "i":I
    iget-object v4, p0, Lc8/zd;->mGraph:Landroid/support/v4/util/SimpleArrayMap;
...
.method getSortedList()Ljava/util/ArrayList;
    ...
    .line 147
    .local p0, "this":Lc8/zd;, "Landroid/support/design/widget/DirectedAcyclicGraph<TT;>;"
    iget-object v2, p0, Lc8/zd;->mSortResult:Ljava/util/ArrayList;

    invoke-virtual {v2}, Ljava/util/ArrayList;->clear()V

    .line 148
    iget-object v2, p0, Lc8/zd;->mSortTmpMarked:Ljava/util/HashSet;
    ...
    .local v0, "i":I
    iget-object v2, p0, Lc8/zd;->mGraph:Landroid/support/v4/util/SimpleArrayMap;
    ...
    iget-object v3, p0, Lc8/zd;->mSortResult:Ljava/util/ArrayList;

    iget-object v4, p0, Lc8/zd;->mSortTmpMarked:Ljava/util/HashSet;

    invoke-direct {p0, v2, v3, v4}, Lc8/zd;->dfs(Ljava/lang/Object;Ljava/util/ArrayList;Ljava/util/HashSet;)V
