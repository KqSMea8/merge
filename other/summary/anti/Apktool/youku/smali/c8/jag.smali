...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lc8/jag;->sThreadLocal:Ljava/lang/ThreadLocal;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lc8/jag;->splits:Ljava/util/List;
...
.method public static getProcessEvents()Ljava/util/List;
    ...
    .line 77
    sget-object v1, Lc8/jag;->sThreadLocal:Ljava/lang/ThreadLocal;

    invoke-virtual {v1}, Ljava/lang/ThreadLocal;->get()Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lc8/jag;

    iget-object v0, v1, Lc8/jag;->splits:Ljava/util/List;
    ...
    iput-object v2, v1, Lc8/jag;->splits:Ljava/util/List;
...
.method public static lastTickStamp()J
    ...
    iget-wide v2, v1, Lc8/jag;->startMillis:J
    :try_end_0
...
.method public static millisUntilNow(J)D
    ...
    invoke-static {v0, v1}, Lc8/jag;->nanosToMillis(J)D
...
.method private static prepare()V
    ...
    .prologue
    .line 38
    sget-object v0, Lc8/jag;->sThreadLocal:Ljava/lang/ThreadLocal;
...
.method public static split(Ljava/lang/String;)V
    ...
    .line 61
    :try_start_0
    new-instance v0, Lc8/iag;

    invoke-direct {v0}, Lc8/iag;-><init>()V

    .line 62
    .local v0, "event":Lc8/iag;
    sget-object v6, Lc8/jag;->sThreadLocal:Ljava/lang/ThreadLocal;

    invoke-virtual {v6}, Ljava/lang/ThreadLocal;->get()Ljava/lang/Object;

    move-result-object v6

    check-cast v6, Lc8/jag;

    iget-wide v4, v6, Lc8/jag;->startMillis:J
    ...
    .line 64
    .local v2, "millis":D
    iput-object p0, v0, Lc8/iag;->fname:Ljava/lang/String;

    .line 65
    iput-wide v2, v0, Lc8/iag;->duration:D

    .line 66
    iput-wide v4, v0, Lc8/iag;->startMillis:J
    ...
    iget-object v6, v6, Lc8/jag;->splits:Ljava/util/List;
...
.method public static tack()D
    ...
    .line 88
    :try_start_0
    sget-object v5, Lc8/jag;->sThreadLocal:Ljava/lang/ThreadLocal;

    invoke-virtual {v5}, Ljava/lang/ThreadLocal;->get()Ljava/lang/Object;

    move-result-object v5

    check-cast v5, Lc8/jag;

    iget-wide v2, v5, Lc8/jag;->startNanos:J
    ...
    invoke-static {v5, v6}, Lc8/xgg;->w(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-wide v6, v5, Lc8/jag;->startNanos:J
...
.method public static tick()V
    ...
    .line 46
    :try_start_0
    invoke-static {}, Lc8/jag;->prepare()V
    ...
    iget-wide v2, v1, Lc8/jag;->startNanos:J
    ...
    iput-wide v2, v1, Lc8/jag;->startNanos:J
    ...
    iput-wide v2, v1, Lc8/jag;->startMillis:J
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
