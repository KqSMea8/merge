...
.method private static beamBeats(ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    .line 243
    invoke-static {p0, p1, p2}, Lc8/Um;->beamsOverlap(ILandroid/graphics/Rect;Landroid/graphics/Rect;)Z

    move-result v0

    .line 244
    .local v0, "rect1InSrcBeam":Z
    invoke-static {p0, p1, p3}, Lc8/Um;->beamsOverlap(ILandroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    .line 257
    :cond_2
    invoke-static {p0, p1, p3}, Lc8/Um;->isToDirectionOf(ILandroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    .line 271
    invoke-static {p0, p1, p2}, Lc8/Um;->majorAxisDistance(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I

    move-result v4

    .line 272
    invoke-static {p0, p1, p3}, Lc8/Um;->majorAxisDistanceToFarEdge(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I
...
.method public static findNextFocusInAbsoluteDirection(Ljava/lang/Object;Lc8/Sm;Lc8/Rm;Ljava/lang/Object;Landroid/graphics/Rect;I)Ljava/lang/Object;
    .locals 8
    ...
    .local p1, "collectionAdapter":Lc8/Sm;, "Landroid/support/v4/widget/FocusStrategy$CollectionAdapter<TL;TT;>;"
    ...
    invoke-interface {p1, p0}, Lc8/Sm;->size(Ljava/lang/Object;)I
    ...
    .line 170
    invoke-interface {p1, p0, v5}, Lc8/Sm;->get(Ljava/lang/Object;I)Ljava/lang/Object;
    ...
    .line 176
    invoke-interface {p2, v3, v4}, Lc8/Rm;->obtainBounds(Ljava/lang/Object;Landroid/graphics/Rect;)V

    .line 177
    invoke-static {p5, p4, v4, v0}, Lc8/Um;->isBetterCandidate(ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)Z
...
.method public static findNextFocusInRelativeDirection(Ljava/lang/Object;Lc8/Sm;Lc8/Rm;Ljava/lang/Object;IZZ)Ljava/lang/Object;
    .locals 6
    .param p0    # Ljava/lang/Object;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
    ...
    .line 43
    invoke-interface {p1, p0, v2}, Lc8/Sm;->get(Ljava/lang/Object;I)Ljava/lang/Object;
    ...
    .line 46
    :cond_0
    new-instance v0, Lc8/Tm;

    invoke-direct {v0, p5, p2}, Lc8/Tm;-><init>(ZLc8/Rm;)V

    .line 47
    .local v0, "comparator":Lc8/Tm;, "Landroid/support/v4/widget/FocusStrategy$SequentialComparator<TT;>;"
    ...
    .line 51
    :pswitch_0
    invoke-static {p3, v3, p6}, Lc8/Um;->getNextFocusable(Ljava/lang/Object;Ljava/util/ArrayList;Z)Ljava/lang/Object;
    ...
    :pswitch_1
    invoke-static {p3, v3, p6}, Lc8/Um;->getPreviousFocusable(Ljava/lang/Object;Ljava/util/ArrayList;Z)Ljava/lang/Object;
...
.method private static isBetterCandidate(ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    .line 203
    invoke-static {p1, p2, p0}, Lc8/Um;->isCandidate(Landroid/graphics/Rect;Landroid/graphics/Rect;I)Z
    ...
    .line 209
    :cond_1
    invoke-static {p1, p3, p0}, Lc8/Um;->isCandidate(Landroid/graphics/Rect;Landroid/graphics/Rect;I)Z
    ...
    .line 214
    :cond_2
    invoke-static {p0, p1, p2, p3}, Lc8/Um;->beamBeats(ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    .line 219
    :cond_3
    invoke-static {p0, p1, p3, p2}, Lc8/Um;->beamBeats(ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    .line 227
    invoke-static {p0, p1, p2}, Lc8/Um;->minorAxisDistance(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I

    move-result v5

    .line 225
    invoke-static {v4, v5}, Lc8/Um;->getWeightedDistanceFor(II)I

    move-result v0

    .line 229
    .local v0, "candidateDist":I
    invoke-static {p0, p1, p3}, Lc8/Um;->majorAxisDistance(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I

    move-result v4

    .line 230
    invoke-static {p0, p1, p3}, Lc8/Um;->minorAxisDistance(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I
...
.method private static majorAxisDistance(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I
    ...
    invoke-static {p0, p1, p2}, Lc8/Um;->majorAxisDistanceRaw(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I
...
.method private static majorAxisDistanceToFarEdge(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I
    ...
    invoke-static {p0, p1, p2}, Lc8/Um;->majorAxisDistanceToFarEdgeRaw(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I
