...
.method public static decode(Ljava/lang/String;)Lc8/HVe;
    .locals 13
    ...
    .line 17
    new-instance v5, Lc8/HVe;

    invoke-direct {v5}, Lc8/HVe;-><init>()V

    .line 18
    .local v5, "utdidObj":Lc8/HVe;
    if-eqz p0, :cond_1
    ...
    :try_start_0
    invoke-static {p0, v8}, Lc8/FWe;->decode(Ljava/lang/String;I)[B
    :try_end_0
    ...
    .line 36
    :try_start_1
    invoke-static {v2}, Lc8/WWe;->calcHmac([B)Ljava/lang/String;

    move-result-object v3

    .line 37
    .local v3, "strResult":Ljava/lang/String;
    invoke-static {v3}, Lc8/JWe;->hashCode(Ljava/lang/String;)I
    ...
    invoke-virtual {v5, v8}, Lc8/HVe;->setValid(Z)V

    .line 40
    invoke-static {v4}, Lc8/kWe;->getLongByByte4([B)J

    move-result-wide v8

    invoke-virtual {v5, v8, v9}, Lc8/HVe;->setTimestamp(J)V

    .line 41
    invoke-virtual {v5, v7}, Lc8/HVe;->setVersion(I)V
    :try_end_1
    ...
    invoke-virtual {v5, v10}, Lc8/HVe;->setValid(Z)V
