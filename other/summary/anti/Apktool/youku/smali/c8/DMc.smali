...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lc8/DMc;->cachedUmidToken:Ljava/lang/String;

    const/4 v0, 0x0

    sput-boolean v0, Lc8/DMc;->initUmidFinished:Z
...
.method private static compatUmidBug(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, v0}, Lc8/IMc;->a(Ljava/lang/String;Ljava/lang/String;)Z
...
.method public static declared-synchronized getSecurityToken(Landroid/content/Context;)Ljava/lang/String;
    ...
    const-class v0, Lc8/DMc;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lc8/DMc;->cachedUmidToken:Ljava/lang/String;
    :try_end_0
...
.method private static declared-synchronized updateLocalUmidToken(Landroid/content/Context;Ljava/lang/String;)V
    ...
    const-class v1, Lc8/DMc;

    monitor-enter v1

    :try_start_0
    invoke-static {p1}, Lc8/IMc;->b(Ljava/lang/String;)Z
    ...
    invoke-static {p0, v0, v2, p1}, Lc8/bNc;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    sput-object p1, Lc8/DMc;->cachedUmidToken:Ljava/lang/String;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
