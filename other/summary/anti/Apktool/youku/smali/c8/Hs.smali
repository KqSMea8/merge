...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lc8/Hs;->TINT_ATTRS:[I
...
.method constructor <init>(Landroid/widget/ProgressBar;)V
    ...
    .line 47
    iput-object p1, p0, Lc8/Hs;->mView:Landroid/widget/ProgressBar;
...
.method private tileify(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .prologue
    .line 72
    instance-of v11, p1, Landroid/support/v4/graphics/drawable/DrawableWrapper;
    ...
    .line 73
    check-cast v11, Landroid/support/v4/graphics/drawable/DrawableWrapper;

    invoke-interface {v11}, Landroid/support/v4/graphics/drawable/DrawableWrapper;->getWrappedDrawable()Landroid/graphics/drawable/Drawable;
    ...
    .line 75
    invoke-direct {p0, v6, p2}, Lc8/Hs;->tileify(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v11, v6}, Landroid/support/v4/graphics/drawable/DrawableWrapper;->setWrappedDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    :goto_2
    invoke-direct {p0, v12, v11}, Lc8/Hs;->tileify(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v11, p0, Lc8/Hs;->mSampleTile:Landroid/graphics/Bitmap;

    if-nez v11, :cond_7

    .line 100
    iput-object v10, p0, Lc8/Hs;->mSampleTile:Landroid/graphics/Bitmap;

    .line 103
    :cond_7
    new-instance v9, Landroid/graphics/drawable/ShapeDrawable;

    invoke-direct {p0}, Lc8/Hs;->getDrawableShape()Landroid/graphics/drawable/shapes/Shape;
...
.method private tileifyIndeterminate(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v5, v6}, Lc8/Hs;->tileify(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
...
.method getSampleTime()Landroid/graphics/Bitmap;
    ...
    .prologue
    .line 144
    iget-object v0, p0, Lc8/Hs;->mSampleTile:Landroid/graphics/Bitmap;
...
.method loadFromAttributes(Landroid/util/AttributeSet;I)V
    ...
    .line 51
    iget-object v2, p0, Lc8/Hs;->mView:Landroid/widget/ProgressBar;

    invoke-virtual {v2}, Landroid/widget/ProgressBar;->getContext()Landroid/content/Context;

    move-result-object v2

    sget-object v3, Lc8/Hs;->TINT_ATTRS:[I
    ...
    .line 54
    .local v0, "a":Lc8/cx;
    invoke-virtual {v0, v4}, Lc8/cx;->getDrawableIfKnown(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v1}, Lc8/Hs;->tileifyIndeterminate(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v1, v4}, Lc8/Hs;->tileify(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
