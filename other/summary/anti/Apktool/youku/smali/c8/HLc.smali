.class public final Lc8/HLc;
.super Lc8/sLc;


# instance fields
.field private g:Lc8/ELc;


# direct methods
.method public constructor <init>(Lc8/ELc;Ljava/lang/reflect/Method;ILjava/lang/String;[BZ)V
    .locals 7
    ...
    invoke-direct/range {v0 .. v6}, Lc8/sLc;-><init>(Ljava/lang/reflect/Method;ILjava/lang/String;[BLjava/lang/String;Z)V

    iput-object p1, p0, Lc8/HLc;->g:Lc8/ELc;
...
.method public final a()Ljava/lang/Object;
    ...
    new-instance v1, Lc8/NLc;

    iget-object v0, p0, Lc8/HLc;->g:Lc8/ELc;

    invoke-interface {v0}, Lc8/ELc;->a()Ljava/lang/String;

    move-result-object v0

    invoke-direct {v1, v0}, Lc8/NLc;-><init>(Ljava/lang/String;)V

    iget-object v0, p0, Lc8/HLc;->b:[B

    invoke-virtual {v1, v0}, Lc8/NLc;->a([B)V

    iget-object v0, p0, Lc8/HLc;->e:Ljava/lang/String;

    invoke-virtual {v1, v0}, Lc8/NLc;->a(Ljava/lang/String;)V

    iget-boolean v0, p0, Lc8/HLc;->f:Z

    invoke-virtual {v1, v0}, Lc8/NLc;->a(Z)V

    const-string/jumbo v0, "id"

    iget v2, p0, Lc8/HLc;->d:I

    invoke-static {v2}, Ljava/lang/String;->valueOf(I)Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v1, v0, v2}, Lc8/NLc;->a(Ljava/lang/String;Ljava/lang/String;)V

    const-string/jumbo v0, "operationType"

    iget-object v2, p0, Lc8/HLc;->c:Ljava/lang/String;

    invoke-virtual {v1, v0, v2}, Lc8/NLc;->a(Ljava/lang/String;Ljava/lang/String;)V

    const-string/jumbo v0, "gzip"

    iget-object v2, p0, Lc8/HLc;->g:Lc8/ELc;

    invoke-interface {v2}, Lc8/ELc;->d()Z
    ...
    invoke-virtual {v1, v0}, Lc8/NLc;->a(Lorg/apache/http/Header;)V

    iget-object v0, p0, Lc8/HLc;->g:Lc8/ELc;

    invoke-interface {v0}, Lc8/ELc;->c()Lc8/tLc;

    move-result-object v0

    invoke-virtual {v0}, Lc8/tLc;->b()Ljava/util/List;
    ...
    invoke-virtual {v1}, Lc8/NLc;->toString()Ljava/lang/String;
    ...
    invoke-interface {v0}, Lc8/ELc;->b()Lc8/uLc;

    move-result-object v0

    invoke-interface {v0, v1}, Lc8/uLc;->a(Lc8/SLc;)Ljava/util/concurrent/Future;
