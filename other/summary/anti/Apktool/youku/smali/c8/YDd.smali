...
.method public constructor <init>(Landroid/content/Context;Lc8/aGd;)V
    ...
    iput-object v0, p0, Lc8/YDd;->a:Landroid/content/Context;

    :cond_0
    iput-object p2, p0, Lc8/YDd;->b:Lc8/aGd;
...
.method private k()[B
    ...
    invoke-virtual {p0}, Lc8/YDd;->g()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Lc8/YDd;->a:Landroid/content/Context;

    invoke-virtual {p0}, Lc8/YDd;->i()Z

    move-result v2

    invoke-static {v0, v2}, Lc8/RFd;->a(Landroid/content/Context;Z)[B

    move-result-object v0

    invoke-static {v0}, Lc8/YDd;->a([B)[B
    ...
    :goto_0
    invoke-virtual {p0}, Lc8/YDd;->f()Ljava/lang/String;
    ...
    :goto_1
    invoke-virtual {p0}, Lc8/YDd;->h()Ljava/lang/String;
...
.method private l()[B
    ...
    :try_start_0
    invoke-virtual {p0}, Lc8/YDd;->a_()[B
...
.method private m()[B
    ...
    invoke-static {v0}, Lc8/RFd;->a([B)[B
...
.method public b_()Ljava/util/Map;
    ...
    invoke-static {v0}, Lc8/IFd;->f(Landroid/content/Context;)Ljava/lang/String;
    ...
    iget-object v2, p0, Lc8/YDd;->a:Landroid/content/Context;
    ...
    invoke-static {v2, v1, v3}, Lc8/RFd;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public final d()[B
    ...
    :try_start_0
    invoke-static {}, Lc8/YDd;->j()[B

    move-result-object v0

    invoke-virtual {v1, v0}, Ljava/io/ByteArrayOutputStream;->write([B)V

    invoke-direct {p0}, Lc8/YDd;->k()[B

    move-result-object v0

    invoke-virtual {v1, v0}, Ljava/io/ByteArrayOutputStream;->write([B)V

    invoke-direct {p0}, Lc8/YDd;->l()[B

    move-result-object v0

    invoke-virtual {v1, v0}, Ljava/io/ByteArrayOutputStream;->write([B)V

    invoke-direct {p0}, Lc8/YDd;->m()[B
...
.method public h()Ljava/lang/String;
    ...
    iget-object v3, p0, Lc8/YDd;->b:Lc8/aGd;

    invoke-virtual {v3}, Lc8/aGd;->c()Ljava/lang/String;
