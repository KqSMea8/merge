...
.method public static buildParamMap(Ljava/util/Map;)Ljava/util/Map;
    .locals 8
    ...
    .line 28
    .local v0, "iAmdcSign":Lc8/vL;
    if-eqz v0, :cond_0

    invoke-interface {v0}, Lc8/vL;->getAppkey()Ljava/lang/String;
    ...
    .line 43
    :cond_2
    invoke-static {}, Lc8/TI;->getUtdid()Ljava/lang/String;
    ...
    .line 48
    .local v1, "networkStatus":Lanet/channel/status/NetworkStatusHelper$NetworkStatus;
    const-string/jumbo v3, "netType"

    invoke-virtual {v1}, Lanet/channel/status/NetworkStatusHelper$NetworkStatus;->toString()Ljava/lang/String;
    ...
    sget-wide v6, Lc8/kL;->latitude:D
    ...
    sget-wide v6, Lc8/kL;->longitude:D
    ...
    .line 59
    invoke-static {p0}, Lc8/qL;->fillTtidInfo(Ljava/util/Map;)V

    .line 62
    const-string/jumbo v3, "domain"

    invoke-static {p0}, Lc8/qL;->formatDomains(Ljava/util/Map;)Ljava/lang/String;
    ...
    invoke-interface {v0}, Lc8/vL;->useSecurityGuard()Z
    ...
    .line 67
    invoke-static {v0, p0}, Lc8/qL;->getSign(Lc8/vL;Ljava/util/Map;)Ljava/lang/String;
...
.method private static fillTtidInfo(Ljava/util/Map;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private static formatDomains(Ljava/util/Map;)Ljava/lang/String;
    .locals 6
...
.method static getSign(Lc8/vL;Ljava/util/Map;)Ljava/lang/String;
    .locals 6
    .param p0, "iSign"    # Lc8/vL;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lc8/vL;",
    ...
    invoke-static {v2}, Lc8/zL;->stringNull2Empty(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-interface {p0, v2}, Lc8/vL;->sign(Ljava/lang/String;)Ljava/lang/String;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string/jumbo v2, "amdc.DispatchParamBuilder"

    const-string/jumbo v4, "get sign failed"

    const/4 v5, 0x0

    new-array v5, v5, [Ljava/lang/Object;

    invoke-static {v2, v4, v3, v0, v5}, Lc8/KL;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;[Ljava/lang/Object;)V
