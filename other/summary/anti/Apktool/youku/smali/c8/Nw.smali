...
.method private invalidateFullSpansAfter(I)I
    ...
    .line 2946
    iget-object v6, p0, Lc8/Nw;->mFullSpanItems:Ljava/util/List;
    ...
    .line 2949
    :cond_1
    invoke-virtual {p0, p1}, Lc8/Nw;->getFullSpanItem(I)Landroid/support/v7/widget/StaggeredGridLayoutManager$LazySpanLookup$FullSpanItem;
    ...
    .line 2964
    iget-object v5, p0, Lc8/Nw;->mFullSpanItems:Ljava/util/List;
...
.method private offsetFullSpansForAddition(II)V
    ...
    .prologue
    .line 2929
    iget-object v2, p0, Lc8/Nw;->mFullSpanItems:Ljava/util/List;
...
.method private offsetFullSpansForRemoval(II)V
    ...
    .prologue
    .line 2899
    iget-object v3, p0, Lc8/Nw;->mFullSpanItems:Ljava/util/List;
...
.method public addFullSpanItem(Landroid/support/v7/widget/StaggeredGridLayoutManager$LazySpanLookup$FullSpanItem;)V
    ...
    iput-object v3, p0, Lc8/Nw;->mFullSpanItems:Ljava/util/List;
...
.method clear()V
    ...
    .prologue
    .line 2880
    iget-object v0, p0, Lc8/Nw;->mData:[I
    ...
    iput-object v0, p0, Lc8/Nw;->mFullSpanItems:Ljava/util/List;
...
.method ensureSize(I)V
    ...
    .line 2868
    iget-object v1, p0, Lc8/Nw;->mData:[I
    ...
    iput-object v1, p0, Lc8/Nw;->mData:[I
    ...
    .line 2873
    .local v0, "old":[I
    invoke-virtual {p0, p1}, Lc8/Nw;->sizeForPosition(I)I
    ...
    iget-object v3, p0, Lc8/Nw;->mData:[I
...
.method forceInvalidateAfter(I)I
    ...
    .end local v1    # "i":I
    :cond_1
    invoke-virtual {p0, p1}, Lc8/Nw;->invalidateAfter(I)I
...
.method public getFirstFullSpanItemInRange(IIIZ)Landroid/support/v7/widget/StaggeredGridLayoutManager$LazySpanLookup$FullSpanItem;
    ...
    .line 3016
    iget-object v4, p0, Lc8/Nw;->mFullSpanItems:Ljava/util/List;
...
.method invalidateAfter(I)I
    ...
    .line 2829
    iget-object v2, p0, Lc8/Nw;->mData:[I
    ...
    .line 2835
    invoke-direct {p0, p1}, Lc8/Nw;->invalidateFullSpansAfter(I)I
...
.method offsetForAddition(II)V
    ...
    invoke-virtual {p0, v0}, Lc8/Nw;->ensureSize(I)V
    ...
    .line 2925
    invoke-direct {p0, p1, p2}, Lc8/Nw;->offsetFullSpansForAddition(II)V
...
.method offsetForRemoval(II)V
    ...
    .line 2895
    invoke-direct {p0, p1, p2}, Lc8/Nw;->offsetFullSpansForRemoval(II)V

    goto :goto_0
.end method

.method setSpan(ILc8/Pw;)V
    .locals 2
    .param p1, "position"    # I
    .param p2, "span"    # Lc8/Pw;

    .prologue
    .line 2855
    invoke-virtual {p0, p1}, Lc8/Nw;->ensureSize(I)V

    .line 2856
    iget-object v0, p0, Lc8/Nw;->mData:[I

    iget v1, p2, Lc8/Pw;->mIndex:I
