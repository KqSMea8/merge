...
.method public static applyStandardTemplate(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;IILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJIIIZ)Landroid/widget/RemoteViews;
    ...
    .line 289
    sget v5, Lcom/youku/phone/R$id;->notification_background:I

    const-string/jumbo v6, "setBackgroundResource"

    sget v7, Lcom/youku/phone/R$drawable;->notification_bg_low:I

    invoke-virtual {v4, v5, v6, v7}, Landroid/widget/RemoteViews;->setInt(ILjava/lang/String;I)V

    .line 291
    sget v5, Lcom/youku/phone/R$id;->icon:I

    const-string/jumbo v6, "setBackgroundResource"

    sget v7, Lcom/youku/phone/R$drawable;->notification_template_icon_low_bg:I
    ...
    .line 311
    sget v5, Lcom/youku/phone/R$dimen;->notification_right_icon_size:I
    ...
    sget v5, Lcom/youku/phone/R$dimen;->notification_small_icon_background_padding:I
    ...
    invoke-static {v0, v1, v10, v13, v2}, Lc8/No;->createIconWithBackground(Landroid/content/Context;IIII)Landroid/graphics/Bitmap;

    move-result-object v18

    .line 321
    .local v18, "smallBit":Landroid/graphics/Bitmap;
    sget v5, Lcom/youku/phone/R$id;->right_icon:I
    ...
    .line 348
    sget v5, Lcom/youku/phone/R$id;->title:I
    ...
    .line 351
    sget v5, Lcom/youku/phone/R$id;->text:I
    ...
    .line 357
    sget v5, Lcom/youku/phone/R$id;->info:I
    ...
    .line 382
    sget v5, Lcom/youku/phone/R$id;->text2:I
    ...
    .line 394
    sget v5, Lcom/youku/phone/R$dimen;->notification_subtext_size:I
    ...
    :cond_5
    sget v5, Lcom/youku/phone/R$id;->line1:I
    ...
    .line 404
    sget v5, Lcom/youku/phone/R$id;->chronometer:I
    ...
    .line 414
    :cond_7
    sget v6, Lcom/youku/phone/R$id;->right_side:I
    ...
    .line 415
    sget v6, Lcom/youku/phone/R$id;->line3:I
    ...
    sget v7, Lcom/youku/phone/R$drawable;->notification_bg:I
    ...
    sget v7, Lcom/youku/phone/R$drawable;->notification_template_icon_bg:I
    ...
    invoke-static {v0, v1, v6}, Lc8/No;->createColoredBitmap(Landroid/content/Context;II)Landroid/graphics/Bitmap;
    ...
    .line 331
    sget v5, Lcom/youku/phone/R$dimen;->notification_large_icon_width:I

    invoke-virtual {v15, v5}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v5

    sget v6, Lcom/youku/phone/R$dimen;->notification_big_circle_margin:I
    ...
    .line 334
    .restart local v10    # "backgroundSize":I
    sget v5, Lcom/youku/phone/R$dimen;->notification_small_icon_size_as_large:I
    ...
    .line 362
    sget v5, Lcom/youku/phone/R$integer;->status_bar_notification_info_maxnum:I
    ...
    sget v6, Lcom/youku/phone/R$string;->status_bar_notification_info_overflow:I
    ...
    .line 409
    :cond_13
    sget v5, Lcom/youku/phone/R$id;->time:I
...
.method public static applyStandardTemplateWithActions(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;IILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJIIIZLjava/util/ArrayList;)Landroid/widget/RemoteViews;
    ...
    invoke-static/range {p0 .. p14}, Lc8/No;->applyStandardTemplate(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;IILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJIIIZ)Landroid/widget/RemoteViews;

    move-result-object v6

    .line 210
    .local v6, "remoteViews":Landroid/widget/RemoteViews;
    sget v7, Lcom/youku/phone/R$id;->actions:I
    ...
    invoke-static {p0, v7}, Lc8/No;->generateActionButton(Landroid/content/Context;Landroid/support/v4/app/NotificationCompat$Action;)Landroid/widget/RemoteViews;
    ...
    .line 225
    sget v7, Lcom/youku/phone/R$id;->action_divider:I
...
.method public static buildIntoRemoteViews(Landroid/content/Context;Landroid/widget/RemoteViews;Landroid/widget/RemoteViews;)V
    ...
    .line 437
    invoke-static {p1}, Lc8/No;->hideNormalContent(Landroid/widget/RemoteViews;)V

    .line 438
    sget v0, Lcom/youku/phone/R$id;->notification_main_column:I
    ...
    .line 443
    sget v1, Lcom/youku/phone/R$id;->notification_main_column_container:I

    .line 444
    invoke-static {p0}, Lc8/No;->calculateTopPadding(Landroid/content/Context;)I
...
.method public static calculateTopPadding(Landroid/content/Context;)I
    ...
    sget v5, Lcom/youku/phone/R$dimen;->notification_top_pad:I
    ...
    sget v5, Lcom/youku/phone/R$dimen;->notification_top_pad_large_text:I
    ...
    invoke-static {v0, v6, v4}, Lc8/No;->constrain(FFF)F
...
.method private static createColoredBitmap(Landroid/content/Context;II)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0, p1, p2, v0}, Lc8/No;->createColoredBitmap(Landroid/content/Context;III)Landroid/graphics/Bitmap;
...
.method public static createIconWithBackground(Landroid/content/Context;IIII)Landroid/graphics/Bitmap;
    ...
    .prologue
    .line 421
    sget v4, Lcom/youku/phone/R$drawable;->notification_icon_background:I
    ...
    :cond_0
    invoke-static {p0, v4, p4, p2}, Lc8/No;->createColoredBitmap(Landroid/content/Context;III)Landroid/graphics/Bitmap;
...
.method private static generateActionButton(Landroid/content/Context;Landroid/support/v4/app/NotificationCompat$Action;)Landroid/widget/RemoteViews;
    ...
    .line 233
    invoke-static {}, Lc8/No;->getActionTombstoneLayoutResource()I
    ...
    sget v2, Lcom/youku/phone/R$id;->action_image:I
    ...
    sget v5, Lcom/youku/phone/R$color;->notification_action_color_filter:I
    ...
    .line 236
    invoke-static {p0, v3, v4}, Lc8/No;->createColoredBitmap(Landroid/content/Context;II)Landroid/graphics/Bitmap;
    ...
    .line 238
    sget v2, Lcom/youku/phone/R$id;->action_text:I
    ...
    .line 240
    sget v2, Lcom/youku/phone/R$id;->action_container:I
    ...
    :cond_3
    invoke-static {}, Lc8/No;->getActionLayoutResource()I
...
.method private static generateContentViewMedia(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJILjava/util/List;[IZLandroid/app/PendingIntent;Z)Landroid/widget/RemoteViews;
    ...
    sget v16, Lcom/youku/phone/R$layout;->notification_template_media_custom:I
    ...
    invoke-static/range {v3 .. v17}, Lc8/No;->applyStandardTemplate(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;IILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJIIIZ)Landroid/widget/RemoteViews;
    ...
    .local v2, "N":I
    :goto_1
    sget v3, Lcom/youku/phone/R$id;->media_actions:I
    ...
    :cond_0
    sget v16, Lcom/youku/phone/R$layout;->notification_template_media:I
    ...
    invoke-static {v0, v1}, Lc8/No;->generateMediaActionButton(Landroid/content/Context;Landroid/support/v4/app/NotificationCompatBase$Action;)Landroid/widget/RemoteViews;
    ...
    .line 111
    sget v3, Lcom/youku/phone/R$id;->end_padder:I
    ...
    .line 112
    sget v3, Lcom/youku/phone/R$id;->cancel_action:I
    ...
    sget v6, Lcom/youku/phone/R$integer;->cancel_button_image_alpha:I
...
.method private static generateMediaActionButton(Landroid/content/Context;Landroid/support/v4/app/NotificationCompatBase$Action;)Landroid/widget/RemoteViews;
    ...
    sget v3, Lcom/youku/phone/R$layout;->notification_media_action:I

    invoke-direct {v0, v2, v3}, Landroid/widget/RemoteViews;-><init>(Ljava/lang/String;I)V

    .line 178
    .local v0, "button":Landroid/widget/RemoteViews;
    sget v2, Lcom/youku/phone/R$id;->action0:I
...
.method public static generateMediaBigView(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJIILjava/util/List;ZLandroid/app/PendingIntent;Z)Landroid/widget/RemoteViews;
    ...
    invoke-static {v0, v2}, Lc8/No;->getBigMediaLayoutResource(ZI)I
    ...
    invoke-static {v0, v3}, Lc8/No;->generateMediaActionButton(Landroid/content/Context;Landroid/support/v4/app/NotificationCompatBase$Action;)Landroid/widget/RemoteViews;
...
.method private static getActionLayoutResource()I
    ...
    .prologue
    .line 268
    sget v0, Lcom/youku/phone/R$layout;->notification_action:I
...
.method private static getActionTombstoneLayoutResource()I
    ...
    .prologue
    .line 272
    sget v0, Lcom/youku/phone/R$layout;->notification_action_tombstone:I
...
.method private static getBigMediaLayoutResource(ZI)I
    ...
    sget v0, Lcom/youku/phone/R$layout;->notification_template_big_media_narrow_custom:I
    ...
    .line 192
    :cond_0
    sget v0, Lcom/youku/phone/R$layout;->notification_template_big_media_narrow:I
    ...
    sget v0, Lcom/youku/phone/R$layout;->notification_template_big_media_custom:I

    goto :goto_0

    :cond_2
    sget v0, Lcom/youku/phone/R$layout;->notification_template_big_media:I
...
.method private static hideNormalContent(Landroid/widget/RemoteViews;)V
    ...
    .line 450
    sget v0, Lcom/youku/phone/R$id;->text2:I

    invoke-virtual {p0, v0, v1}, Landroid/widget/RemoteViews;->setViewVisibility(II)V

    .line 451
    sget v0, Lcom/youku/phone/R$id;->text:I
...
.method public static overrideContentViewMedia(Landroid/support/v4/app/NotificationBuilderWithBuilderAccessor;Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJILjava/util/List;[IZLandroid/app/PendingIntent;Z)Landroid/widget/RemoteViews;
    ...
    .line 66
    .local p12, "actions":Ljava/util/List;, "Ljava/util/List<TT;>;"
    invoke-static/range {p1 .. p16}, Lc8/No;->generateContentViewMedia(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJILjava/util/List;[IZLandroid/app/PendingIntent;Z)Landroid/widget/RemoteViews;
...
.method public static overrideMediaBigContentView(Landroid/app/Notification;Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJIILjava/util/List;ZLandroid/app/PendingIntent;Z)V
    ...
    invoke-static/range {p1 .. p16}, Lc8/No;->generateMediaBigView(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJIILjava/util/List;ZLandroid/app/PendingIntent;Z)Landroid/widget/RemoteViews;
