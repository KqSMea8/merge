...
.field private final mSearchView:Lc8/zw;
...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lc8/zw;Landroid/app/SearchableInfo;Ljava/util/WeakHashMap;)V
    .locals 4
    .param p1, "context"    # Landroid/content/Context;
    .param p2, "searchView"    # Lc8/zw;
    ...
    .line 94
    invoke-virtual {p2}, Lc8/zw;->getSuggestionRowLayout()I
    ...
    iput-boolean v0, p0, Lc8/Sw;->mClosed:Z

    .line 74
    iput v3, p0, Lc8/Sw;->mQueryRefinement:I

    .line 82
    iput v2, p0, Lc8/Sw;->mText1Col:I

    .line 83
    iput v2, p0, Lc8/Sw;->mText2Col:I

    .line 84
    iput v2, p0, Lc8/Sw;->mText2UrlCol:I

    .line 85
    iput v2, p0, Lc8/Sw;->mIconName1Col:I

    .line 86
    iput v2, p0, Lc8/Sw;->mIconName2Col:I

    .line 87
    iput v2, p0, Lc8/Sw;->mFlagsCol:I

    .line 96
    iget-object v0, p0, Lc8/Sw;->mContext:Landroid/content/Context;
    ...
    iput-object v0, p0, Lc8/Sw;->mSearchManager:Landroid/app/SearchManager;

    .line 97
    iput-object p2, p0, Lc8/Sw;->mSearchView:Lc8/zw;

    .line 98
    iput-object p3, p0, Lc8/Sw;->mSearchable:Landroid/app/SearchableInfo;

    .line 99
    invoke-virtual {p2}, Lc8/zw;->getSuggestionCommitIconResId()I

    move-result v0

    iput v0, p0, Lc8/Sw;->mCommitIconResId:I

    .line 102
    iput-object p1, p0, Lc8/Sw;->mProviderContext:Landroid/content/Context;

    .line 104
    iput-object p4, p0, Lc8/Sw;->mOutsideDrawablesCache:Ljava/util/WeakHashMap;
...
.method private checkIconCache(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    .prologue
    .line 559
    iget-object v1, p0, Lc8/Sw;->mOutsideDrawablesCache:Ljava/util/WeakHashMap;
...
.method private formatUrl(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    .line 335
    iget-object v0, p0, Lc8/Sw;->mUrlColor:Landroid/content/res/ColorStateList;
    ...
    sget v3, Lcom/youku/phone/R$attr;->textColorSearchUrl:I
    ...
    iput-object v0, p0, Lc8/Sw;->mUrlColor:Landroid/content/res/ColorStateList;
    ...
    iget-object v4, p0, Lc8/Sw;->mUrlColor:Landroid/content/res/ColorStateList;
...
.method private getActivityIcon(Landroid/content/ComponentName;)Landroid/graphics/drawable/Drawable;
    ...
    .line 623
    iget-object v7, p0, Lc8/Sw;->mContext:Landroid/content/Context;
...
.method private getActivityIconWithCache(Landroid/content/ComponentName;)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v4, p0, Lc8/Sw;->mOutsideDrawablesCache:Ljava/util/WeakHashMap;
    ...
    :cond_0
    iget-object v4, p0, Lc8/Sw;->mProviderContext:Landroid/content/Context;
    ...
    .end local v0    # "cached":Landroid/graphics/drawable/Drawable$ConstantState;
    :cond_1
    invoke-direct {p0, p1}, Lc8/Sw;->getActivityIcon(Landroid/content/ComponentName;)Landroid/graphics/drawable/Drawable;
...
.method public static getColumnString(Landroid/database/Cursor;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 653
    .local v0, "col":I
    invoke-static {p0, v0}, Lc8/Sw;->getStringOrNull(Landroid/database/Cursor;I)Ljava/lang/String;
...
.method private getDefaultIcon1(Landroid/database/Cursor;)Landroid/graphics/drawable/Drawable;
    ...
    .prologue
    .line 582
    iget-object v1, p0, Lc8/Sw;->mSearchable:Landroid/app/SearchableInfo;

    invoke-virtual {v1}, Landroid/app/SearchableInfo;->getSearchActivity()Landroid/content/ComponentName;

    move-result-object v1

    invoke-direct {p0, v1}, Lc8/Sw;->getActivityIconWithCache(Landroid/content/ComponentName;)Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    iget-object v1, p0, Lc8/Sw;->mContext:Landroid/content/Context;
...
.method private getDrawable(Landroid/net/Uri;)Landroid/graphics/drawable/Drawable;
    ...
    .line 530
    :try_start_1
    invoke-virtual {p0, p1}, Lc8/Sw;->getDrawableFromResourceUri(Landroid/net/Uri;)Landroid/graphics/drawable/Drawable;
    :try_end_1
    ...
    const-string/jumbo v6, "Icon not found: "
...
.method private getDrawableFromResourceValue(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v6, p0, Lc8/Sw;->mProviderContext:Landroid/content/Context;
    ...
    invoke-direct {p0, v1}, Lc8/Sw;->checkIconCache(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    .line 498
    iget-object v5, p0, Lc8/Sw;->mProviderContext:Landroid/content/Context;
    ...
    .line 500
    invoke-direct {p0, v1, v0}, Lc8/Sw;->storeInIconCache(Ljava/lang/String;Landroid/graphics/drawable/Drawable;)V
    :try_end_0
    ...
    invoke-direct {p0, p1}, Lc8/Sw;->checkIconCache(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v3}, Lc8/Sw;->getDrawable(Landroid/net/Uri;)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    .line 510
    invoke-direct {p0, p1, v0}, Lc8/Sw;->storeInIconCache(Ljava/lang/String;Landroid/graphics/drawable/Drawable;)V
    ...
    const-string/jumbo v6, "Icon resource not found: "
...
.method private getIcon1(Landroid/database/Cursor;)Landroid/graphics/drawable/Drawable;
    ...
    .prologue
    .line 361
    iget v2, p0, Lc8/Sw;->mIconName1Col:I
    ...
    invoke-direct {p0, v1}, Lc8/Sw;->getDrawableFromResourceValue(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    .line 369
    invoke-direct {p0, p1}, Lc8/Sw;->getDefaultIcon1(Landroid/database/Cursor;)Landroid/graphics/drawable/Drawable;
...
.method private getIcon2(Landroid/database/Cursor;)Landroid/graphics/drawable/Drawable;
    ...
    .prologue
    .line 373
    iget v1, p0, Lc8/Sw;->mIconName2Col:I
    ...
    invoke-direct {p0, v0}, Lc8/Sw;->getDrawableFromResourceValue(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
...
.method private storeInIconCache(Ljava/lang/String;Landroid/graphics/drawable/Drawable;)V
    ...
    .line 569
    iget-object v0, p0, Lc8/Sw;->mOutsideDrawablesCache:Ljava/util/WeakHashMap;
...
.method public bindView(Landroid/view/View;Landroid/content/Context;Landroid/database/Cursor;)V
    ...
    check-cast v3, Lc8/Rw;

    .line 276
    .local v3, "views":Lc8/Rw;
    const/4 v0, 0x0

    .line 277
    .local v0, "flags":I
    iget v4, p0, Lc8/Sw;->mFlagsCol:I
    ...
    .line 280
    :cond_0
    iget-object v4, v3, Lc8/Rw;->mText1:Landroid/widget/TextView;

    if-eqz v4, :cond_1

    .line 281
    iget v4, p0, Lc8/Sw;->mText1Col:I

    invoke-static {p3, v4}, Lc8/Sw;->getStringOrNull(Landroid/database/Cursor;I)Ljava/lang/String;
    ...
    invoke-direct {p0, v4, v1}, Lc8/Sw;->setViewText(Landroid/widget/TextView;Ljava/lang/CharSequence;)V

    .line 284
    .end local v1    # "text1":Ljava/lang/String;
    :cond_1
    iget-object v4, v3, Lc8/Rw;->mText2:Landroid/widget/TextView;

    if-eqz v4, :cond_3

    .line 286
    iget v4, p0, Lc8/Sw;->mText2UrlCol:I
    ...
    .line 288
    invoke-direct {p0, v2}, Lc8/Sw;->formatUrl(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    invoke-direct {p0, v4, v2}, Lc8/Sw;->setViewText(Landroid/widget/TextView;Ljava/lang/CharSequence;)V

    .line 309
    .end local v2    # "text2":Ljava/lang/CharSequence;
    :cond_3
    iget-object v4, v3, Lc8/Rw;->mIcon1:Landroid/widget/ImageView;
    ...
    invoke-direct {p0, p3}, Lc8/Sw;->getIcon1(Landroid/database/Cursor;)Landroid/graphics/drawable/Drawable;

    move-result-object v5

    const/4 v6, 0x4

    invoke-direct {p0, v4, v5, v6}, Lc8/Sw;->setViewDrawable(Landroid/widget/ImageView;Landroid/graphics/drawable/Drawable;I)V

    .line 312
    :cond_4
    iget-object v4, v3, Lc8/Rw;->mIcon2:Landroid/widget/ImageView;
    ...
    invoke-direct {p0, p3}, Lc8/Sw;->getIcon2(Landroid/database/Cursor;)Landroid/graphics/drawable/Drawable;

    move-result-object v5

    invoke-direct {p0, v4, v5, v10}, Lc8/Sw;->setViewDrawable(Landroid/widget/ImageView;Landroid/graphics/drawable/Drawable;I)V

    .line 315
    :cond_5
    iget v4, p0, Lc8/Sw;->mQueryRefinement:I
    ...
    .line 318
    :cond_6
    iget-object v4, v3, Lc8/Rw;->mIconRefine:Landroid/widget/ImageView;
    ...
    iget-object v5, v3, Lc8/Rw;->mText1:Landroid/widget/TextView;
...
.method public changeCursor(Landroid/database/Cursor;)V
    ...
    .prologue
    .line 216
    iget-boolean v1, p0, Lc8/Sw;->mClosed:Z
    ...
    iput v1, p0, Lc8/Sw;->mText2UrlCol:I
    ...
    iput v1, p0, Lc8/Sw;->mIconName1Col:I
    ...
    iput v1, p0, Lc8/Sw;->mIconName2Col:I
...
.method public close()V
    ...
    invoke-virtual {p0, v0}, Lc8/Sw;->changeCursor(Landroid/database/Cursor;)V
...
.method public convertToString(Landroid/database/Cursor;)Ljava/lang/CharSequence;
    ...
    invoke-static {p1, v4}, Lc8/Sw;->getColumnString(Landroid/database/Cursor;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 423
    iget-object v4, p0, Lc8/Sw;->mSearchable:Landroid/app/SearchableInfo;
...
.method getDrawableFromResourceUri(Landroid/net/Uri;)Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    :try_start_0
    iget-object v5, p0, Lc8/Sw;->mContext:Landroid/content/Context;
...
.method public getQueryRefinement()I
    ...
    .prologue
    .line 125
    iget v0, p0, Lc8/Sw;->mQueryRefinement:I
...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    iget-object v4, p0, Lc8/Sw;->mContext:Landroid/content/Context;

    iget-object v5, p0, Lc8/Sw;->mCursor:Landroid/database/Cursor;

    invoke-virtual {p0, v4, v5, p3}, Lc8/Sw;->newView(Landroid/content/Context;Landroid/database/Cursor;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 456
    .local v3, "views":Lc8/Rw;
    iget-object v1, v3, Lc8/Rw;->mText1:Landroid/widget/TextView;
...
.method public newView(Landroid/content/Context;Landroid/database/Cursor;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    new-instance v2, Lc8/Rw;

    invoke-direct {v2, v1}, Lc8/Rw;-><init>(Landroid/view/View;)V

    invoke-virtual {v1, v2}, Landroid/view/View;->setTag(Ljava/lang/Object;)V

    .line 247
    sget v2, Lcom/youku/phone/R$id;->edit_query:I
    ...
    iget v2, p0, Lc8/Sw;->mCommitIconResId:I
...
.method public notifyDataSetChanged()V
    ...
    .line 182
    invoke-virtual {p0}, Lc8/Sw;->getCursor()Landroid/database/Cursor;

    move-result-object v0

    invoke-direct {p0, v0}, Lc8/Sw;->updateSpinnerState(Landroid/database/Cursor;)V
...
.method public onClick(Landroid/view/View;)V
    ...
    .line 330
    iget-object v1, p0, Lc8/Sw;->mSearchView:Lc8/zw;

    check-cast v0, Ljava/lang/CharSequence;

    .end local v0    # "tag":Ljava/lang/Object;
    invoke-virtual {v1, v0}, Lc8/zw;->onQueryRefine(Ljava/lang/CharSequence;)V
...
.method public runQueryOnBackgroundThread(Ljava/lang/CharSequence;)Landroid/database/Cursor;
    ...
    .local v1, "query":Ljava/lang/String;
    :goto_0
    iget-object v3, p0, Lc8/Sw;->mSearchView:Lc8/zw;

    invoke-virtual {v3}, Lc8/zw;->getVisibility()I
    ...
    .line 152
    invoke-virtual {v3}, Lc8/zw;->getWindowVisibility()I
    ...
    :cond_2
    :try_start_0
    iget-object v3, p0, Lc8/Sw;->mSearchable:Landroid/app/SearchableInfo;

    const/16 v4, 0x32

    invoke-virtual {p0, v3, v1, v4}, Lc8/Sw;->getSearchManagerSuggestions(Landroid/app/SearchableInfo;Ljava/lang/String;I)Landroid/database/Cursor;
...
.method public setQueryRefinement(I)V
    ...
    .prologue
    .line 117
    iput p1, p0, Lc8/Sw;->mQueryRefinement:I
