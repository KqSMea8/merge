...
# virtual methods
.method public parse(Lc8/qmd;)Lc8/Mjd;
    .locals 5
    .param p1, "json"    # Lc8/qmd;
    ...
    invoke-virtual {p1, v2}, Lc8/qmd;->setLenient(Z)V
    ...
    .line 90
    invoke-virtual {p1, v1}, Lc8/qmd;->setLenient(Z)V
...
.method public parse(Ljava/io/Reader;)Lc8/Mjd;
    .locals 5
    ...
    .line 58
    :try_start_0
    new-instance v2, Lc8/qmd;

    invoke-direct {v2, p1}, Lc8/qmd;-><init>(Ljava/io/Reader;)V

    .line 59
    .local v2, "jsonReader":Lc8/qmd;
    invoke-virtual {p0, v2}, Lc8/Pjd;->parse(Lc8/qmd;)Lc8/Mjd;

    move-result-object v1

    .line 60
    .local v1, "element":Lc8/Mjd;
    invoke-virtual {v1}, Lc8/Mjd;->isJsonNull()Z

    move-result v3

    if-nez v3, :cond_0

    invoke-virtual {v2}, Lc8/qmd;->peek()Lcom/google/gson/stream/JsonToken;
    ...
    .line 64
    .end local v1    # "element":Lc8/Mjd;
    .end local v2    # "jsonReader":Lc8/qmd;
    :catch_0
    move-exception v0
    ...
    .restart local v1    # "element":Lc8/Mjd;
    .restart local v2    # "jsonReader":Lc8/qmd;
    :cond_0
    return-object v1
.end method

.method public parse(Ljava/lang/String;)Lc8/Mjd;
    .locals 1
    ...
    invoke-virtual {p0, v0}, Lc8/Pjd;->parse(Ljava/io/Reader;)Lc8/Mjd;
