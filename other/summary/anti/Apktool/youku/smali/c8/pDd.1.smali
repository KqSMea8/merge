...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    iput-object p1, p0, Lc8/pDd;->b:Landroid/content/Context;

    iget-object v0, p0, Lc8/pDd;->b:Landroid/content/Context;

    invoke-static {v0, p2}, Lc8/pDd;->a(Landroid/content/Context;Z)Lc8/eDd;

    move-result-object v0

    iput-object v0, p0, Lc8/pDd;->a:Lc8/eDd;

    return-void
.end method

.method private static a(Landroid/content/Context;Z)Lc8/eDd;
    .locals 4
...
.method public final a()Ljava/util/List;
    ...
    :try_start_0
    invoke-static {}, Lc8/aGd;->g()Ljava/lang/String;

    move-result-object v1

    iget-object v2, p0, Lc8/pDd;->a:Lc8/eDd;

    const-class v3, Lc8/aGd;

    const/4 v4, 0x1

    invoke-virtual {v2, v1, v3, v4}, Lc8/eDd;->a(Ljava/lang/String;Ljava/lang/Class;Z)Ljava/util/List;
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final a(Lc8/aGd;)V
    .locals 4
    ...
    :cond_1
    :try_start_0
    iget-object v0, p0, Lc8/pDd;->a:Lc8/eDd;
    ...
    invoke-static {v0, v2}, Lc8/pDd;->a(Landroid/content/Context;Z)Lc8/eDd;
    ...
    invoke-virtual {v0, p1}, Lc8/aGd;->equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v0, v2, p1}, Lc8/eDd;->a(Ljava/lang/String;Ljava/lang/Object;)V
    :try_end_1
