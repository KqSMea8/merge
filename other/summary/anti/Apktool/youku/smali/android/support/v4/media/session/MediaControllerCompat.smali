...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
    ...
    invoke-direct {v0, p1, p2}, Lc8/gl;-><init>(Landroid/content/Context;Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v4/media/session/MediaSessionCompat;)V
    ...
    invoke-direct {v0, p1, p2}, Lc8/gl;-><init>(Landroid/content/Context;Landroid/support/v4/media/session/MediaSessionCompat;)V
...
.method public static getMediaController(Landroid/app/Activity;)Landroid/support/v4/media/session/MediaControllerCompat;
    ...
    .line 133
    instance-of v5, p0, Lc8/Qi;

    if-eqz v5, :cond_1

    .line 134
    check-cast p0, Lc8/Qi;

    .end local p0    # "activity":Landroid/app/Activity;
    const-class v5, Lc8/bl;

    .line 135
    invoke-virtual {p0, v5}, Lc8/Qi;->getExtraData(Ljava/lang/Class;)Lc8/Pi;

    move-result-object v2

    check-cast v2, Lc8/bl;

    .line 136
    .local v2, "extraData":Lc8/bl;
    if-eqz v2, :cond_0

    invoke-virtual {v2}, Lc8/bl;->getMediaController()Landroid/support/v4/media/session/MediaControllerCompat;

    move-result-object v4

    .line 150
    .end local v2    # "extraData":Lc8/bl;
...
.method public static setMediaController(Landroid/app/Activity;Landroid/support/v4/media/session/MediaControllerCompat;)V
    ...
    new-instance v3, Lc8/bl;

    invoke-direct {v3, p1}, Lc8/bl;-><init>(Landroid/support/v4/media/session/MediaControllerCompat;)V

    invoke-virtual {v2, v3}, Lc8/Qi;->putExtraData(Lc8/Pi;)V
