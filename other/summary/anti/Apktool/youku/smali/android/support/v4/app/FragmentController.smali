...
.method public restoreAllState(Landroid/os/Parcelable;Lc8/si;)V
    .locals 1
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v4/app/FragmentManagerImpl;->restoreAllState(Landroid/os/Parcelable;Lc8/si;)V
...
.method public restoreAllState(Landroid/os/Parcelable;Ljava/util/List;)V
    ...
    new-instance v1, Lc8/si;

    const/4 v2, 0x0

    invoke-direct {v1, p2, v2}, Lc8/si;-><init>(Ljava/util/List;Ljava/util/List;)V

    invoke-virtual {v0, p1, v1}, Landroid/support/v4/app/FragmentManagerImpl;->restoreAllState(Landroid/os/Parcelable;Lc8/si;)V
...
.method public retainNestedNonConfig()Lc8/si;
    .locals 1
    ...
    invoke-virtual {v0}, Landroid/support/v4/app/FragmentManagerImpl;->retainNonConfig()Lc8/si;
...
.method public retainNonConfig()Ljava/util/List;
    ...
    invoke-virtual {v1}, Landroid/support/v4/app/FragmentManagerImpl;->retainNonConfig()Lc8/si;

    move-result-object v0

    .line 171
    .local v0, "nonconf":Lc8/si;
    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lc8/si;->getFragments()Ljava/util/List;
