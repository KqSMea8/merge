...
.method private static _3load(Ljava/lang/String;)V
    .locals 5
...
.method private helpDestroy()V
    ...
    .line 1648
    :try_start_0
    iget-boolean v3, p0, Landroid/support/v8/renderscript/RenderScript;->mDestroyed:Z
    ...
    iput-boolean v3, p0, Landroid/support/v8/renderscript/RenderScript;->mDestroyed:Z
    ...
    iput-boolean v4, v3, Landroid/support/v8/renderscript/RenderScript$MessageThread;->mRun:Z

    .line 1665
    iget-object v3, p0, Landroid/support/v8/renderscript/RenderScript;->mMessageThread:Landroid/support/v8/renderscript/RenderScript$MessageThread;

    invoke-virtual {v3}, Landroid/support/v8/renderscript/RenderScript$MessageThread;->interrupt()V

    .line 1669
    const/4 v0, 0x0

    .local v0, "hasJoined":Z
    const/4 v1, 0x0
...
.method private static internalCreate(Landroid/content/Context;ILandroid/support/v8/renderscript/RenderScript$ContextType;I)Landroid/support/v8/renderscript/RenderScript;
    ...
    invoke-static {v6}, Landroid/support/v8/renderscript/RenderScript;->_1forName(Ljava/lang/String;)Ljava/lang/Class;
    ...
    invoke-static {v11, v6, v8}, Landroid/support/v8/renderscript/RenderScript;->_2invoke(Ljava/lang/reflect/Method;Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v6}, Landroid/support/v8/renderscript/RenderScript;->_3load(Ljava/lang/String;)V
    ...
    .line 1426
    invoke-static {v12}, Landroid/support/v8/renderscript/RenderScript;->_3load(Ljava/lang/String;)V
    :try_end_4
    ...
    invoke-static {v6}, Lc8/ZA;->loadLibrary(Ljava/lang/String;)V
    :try_end_6
    ...
    const-string/jumbo v7, "Unable to load BLAS lib, ONLY BNNM will be supported: "
...
.method private static setupNative(ILandroid/content/Context;)Z
    ...
    sput v11, Landroid/support/v8/renderscript/RenderScript;->sNative:I

    .line 151
    :cond_0
    sget v11, Landroid/support/v8/renderscript/RenderScript;->sNative:I
    ...
    invoke-static {v11}, Landroid/support/v8/renderscript/RenderScript;->_1forName(Ljava/lang/String;)Ljava/lang/Class;
    ...
    const-string/jumbo v12, "debug.rs.forcecompat"
    ...
    invoke-static {v4, v11, v0}, Landroid/support/v8/renderscript/RenderScript;->_2invoke(Ljava/lang/reflect/Method;Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :try_start_2
    const-string/jumbo v11, "android.renderscript.RenderScript"
    ...
    const-string/jumbo v11, "getMinorID"
    ...
    invoke-static {v3, v11, v12}, Landroid/support/v8/renderscript/RenderScript;->_2invoke(Ljava/lang/reflect/Method;Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    const-string/jumbo v12, "com.android.support.v8.renderscript.EnableAsyncTeardown"
    ...
    const-string/jumbo v12, "com.android.support.v8.renderscript.EnableBlurWorkaround"
    ...
    .line 216
    sget-object v11, Landroid/support/v8/renderscript/RenderScript;->mBlackList:Ljava/lang/String;
...
.method declared-synchronized nScriptIntrinsicCreate(IJZ)J
    ...
    const-string/jumbo v5, "/libRSSupport.so"
