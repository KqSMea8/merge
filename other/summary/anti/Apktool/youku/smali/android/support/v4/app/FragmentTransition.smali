...
.method public static synthetic access$000(Ljava/util/ArrayList;I)V
    .locals 0
...
.method public static synthetic access$100(Ljava/lang/Object;Landroid/support/v4/app/Fragment;Ljava/util/ArrayList;Landroid/view/View;)Ljava/util/ArrayList;
    .locals 1
...
.method public static synthetic access$200(Landroid/support/v4/app/Fragment;Landroid/support/v4/app/Fragment;ZLandroid/support/v4/util/ArrayMap;Z)V
    .locals 0
...
.method public static synthetic access$300(Landroid/support/v4/util/ArrayMap;Ljava/lang/Object;Lc8/xi;)Landroid/support/v4/util/ArrayMap;
    .locals 1
    ...
    .prologue
    .line 37
    invoke-static {p0, p1, p2}, Landroid/support/v4/app/FragmentTransition;->captureInSharedElements(Landroid/support/v4/util/ArrayMap;Ljava/lang/Object;Lc8/xi;)Landroid/support/v4/util/ArrayMap;
...
.method public static synthetic access$400(Landroid/support/v4/util/ArrayMap;Lc8/xi;Ljava/lang/Object;Z)Landroid/view/View;
    .locals 1
    .param p0, "x0"    # Landroid/support/v4/util/ArrayMap;
    .param p1, "x1"    # Lc8/xi;
    ...
    .prologue
    .line 37
    invoke-static {p0, p1, p2, p3}, Landroid/support/v4/app/FragmentTransition;->getInEpicenterView(Landroid/support/v4/util/ArrayMap;Lc8/xi;Ljava/lang/Object;Z)Landroid/view/View;
...
.method private static addToFirstInLastOut(Landroid/support/v4/app/BackStackRecord;Landroid/support/v4/app/BackStackRecord$Op;Landroid/util/SparseArray;ZZ)V
    ...
    check-cast v9, Lc8/xi;

    .line 1065
    .local v9, "containerTransition":Lc8/xi;
    if-eqz v11, :cond_2

    .line 1067
    move-object/from16 v0, p2

    invoke-static {v9, v0, v8}, Landroid/support/v4/app/FragmentTransition;->ensureContainer(Lc8/xi;Landroid/util/SparseArray;I)Lc8/xi;

    move-result-object v9

    .line 1068
    iput-object v2, v9, Lc8/xi;->lastIn:Landroid/support/v4/app/Fragment;

    .line 1069
    move/from16 v0, p3

    iput-boolean v0, v9, Lc8/xi;->lastInIsPop:Z

    .line 1070
    iput-object p0, v9, Lc8/xi;->lastInTransaction:Landroid/support/v4/app/BackStackRecord;
    ...
    iget-object v3, v9, Lc8/xi;->firstOut:Landroid/support/v4/app/Fragment;
    ...
    iput-object v3, v9, Lc8/xi;->firstOut:Landroid/support/v4/app/Fragment;
    ...
    .line 1091
    iput-object v2, v9, Lc8/xi;->firstOut:Landroid/support/v4/app/Fragment;

    .line 1092
    move/from16 v0, p3

    iput-boolean v0, v9, Lc8/xi;->firstOutIsPop:Z

    .line 1093
    iput-object p0, v9, Lc8/xi;->firstOutTransaction:Landroid/support/v4/app/BackStackRecord;
    ...
    iget-object v3, v9, Lc8/xi;->lastIn:Landroid/support/v4/app/Fragment;
    ...
    iput-object v3, v9, Lc8/xi;->lastIn:Landroid/support/v4/app/Fragment;

    goto :goto_0

    .line 1021
    .end local v7    # "command":I
    .end local v9    # "containerTransition":Lc8/xi;
...
.method private static captureInSharedElements(Landroid/support/v4/util/ArrayMap;Ljava/lang/Object;Lc8/xi;)Landroid/support/v4/util/ArrayMap;
    .locals 11
    .param p1, "sharedElementTransition"    # Ljava/lang/Object;
    .param p2, "fragments"    # Lc8/xi;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Landroid/support/v4/util/ArrayMap",
    ...
    iget-object v2, p2, Lc8/xi;->lastIn:Landroid/support/v4/app/Fragment;
    ...
    .line 753
    iget-object v4, p2, Lc8/xi;->lastInTransaction:Landroid/support/v4/app/BackStackRecord;

    .line 754
    .local v4, "inTransaction":Landroid/support/v4/app/BackStackRecord;
    iget-boolean v10, p2, Lc8/xi;->lastInIsPop:Z
...
.method private static captureOutSharedElements(Landroid/support/v4/util/ArrayMap;Ljava/lang/Object;Lc8/xi;)Landroid/support/v4/util/ArrayMap;
    .locals 10
    .param p1, "sharedElementTransition"    # Ljava/lang/Object;
    .param p2, "fragments"    # Lc8/xi;
    .annotation system Ldalvik/annotation/Signature;
    ...
    .line 691
    :cond_2
    iget-object v3, p2, Lc8/xi;->firstOut:Landroid/support/v4/app/Fragment;
    ...
    .line 697
    iget-object v5, p2, Lc8/xi;->firstOutTransaction:Landroid/support/v4/app/BackStackRecord;

    .line 698
    .local v5, "outTransaction":Landroid/support/v4/app/BackStackRecord;
    iget-boolean v9, p2, Lc8/xi;->firstOutIsPop:Z
...
.method private static configureSharedElementsOptimized(Landroid/view/ViewGroup;Landroid/view/View;Landroid/support/v4/util/ArrayMap;Lc8/xi;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    .locals 14
    .param p0, "sceneRoot"    # Landroid/view/ViewGroup;
    .param p1, "nonExistentView"    # Landroid/view/View;
    .param p3, "fragments"    # Lc8/xi;
    ...
    iget-object v3, v0, Lc8/xi;->lastIn:Landroid/support/v4/app/Fragment;

    .line 467
    .local v3, "inFragment":Landroid/support/v4/app/Fragment;
    move-object/from16 v0, p3

    iget-object v4, v0, Lc8/xi;->firstOut:Landroid/support/v4/app/Fragment;
    ...
    iget-boolean v5, v0, Lc8/xi;->lastInIsPop:Z
    ...
    invoke-static {v0, v12, v1}, Landroid/support/v4/app/FragmentTransition;->captureOutSharedElements(Landroid/support/v4/util/ArrayMap;Ljava/lang/Object;Lc8/xi;)Landroid/support/v4/util/ArrayMap;
    ...
    invoke-static {v0, v12, v1}, Landroid/support/v4/app/FragmentTransition;->captureInSharedElements(Landroid/support/v4/util/ArrayMap;Ljava/lang/Object;Lc8/xi;)Landroid/support/v4/util/ArrayMap;
    ...
    iget-boolean v9, v0, Lc8/xi;->firstOutIsPop:Z

    .line 514
    .local v9, "outIsPop":Z
    move-object/from16 v0, p3

    iget-object v11, v0, Lc8/xi;->firstOutTransaction:Landroid/support/v4/app/BackStackRecord;
    ...
    invoke-static {v6, v0, v1, v5}, Landroid/support/v4/app/FragmentTransition;->getInEpicenterView(Landroid/support/v4/util/ArrayMap;Lc8/xi;Ljava/lang/Object;Z)Landroid/view/View;
    ...
    :cond_8
    :goto_3
    new-instance v2, Lc8/vi;

    invoke-direct/range {v2 .. v8}, Lc8/vi;-><init>(Landroid/support/v4/app/Fragment;Landroid/support/v4/app/Fragment;ZLandroid/support/v4/util/ArrayMap;Landroid/view/View;Landroid/graphics/Rect;)V

    invoke-static {p0, v2}, Lc8/Ii;->add(Landroid/view/View;Ljava/lang/Runnable;)Lc8/Ii;
...
.method private static configureSharedElementsUnoptimized(Landroid/view/ViewGroup;Landroid/view/View;Landroid/support/v4/util/ArrayMap;Lc8/xi;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    .locals 19
    .param p0, "sceneRoot"    # Landroid/view/ViewGroup;
    .param p1, "nonExistentView"    # Landroid/view/View;
    .param p3, "fragments"    # Lc8/xi;
    ...
    iget-object v9, v0, Lc8/xi;->lastIn:Landroid/support/v4/app/Fragment;

    .line 595
    .local v9, "inFragment":Landroid/support/v4/app/Fragment;
    move-object/from16 v0, p3

    iget-object v10, v0, Lc8/xi;->firstOut:Landroid/support/v4/app/Fragment;
    ...
    iget-boolean v11, v0, Lc8/xi;->lastInIsPop:Z
    ...
    invoke-static {v0, v1, v2}, Landroid/support/v4/app/FragmentTransition;->captureOutSharedElements(Landroid/support/v4/util/ArrayMap;Ljava/lang/Object;Lc8/xi;)Landroid/support/v4/util/ArrayMap;
    ...
    iget-boolean v15, v0, Lc8/xi;->firstOutIsPop:Z

    .line 627
    .local v15, "outIsPop":Z
    move-object/from16 v0, p3

    iget-object v0, v0, Lc8/xi;->firstOutTransaction:Landroid/support/v4/app/BackStackRecord;
    ...
    invoke-direct/range {v3 .. v14}, Lc8/wi;-><init>(Landroid/support/v4/util/ArrayMap;Ljava/lang/Object;Lc8/xi;Ljava/util/ArrayList;Landroid/view/View;Landroid/support/v4/app/Fragment;Landroid/support/v4/app/Fragment;ZLjava/util/ArrayList;Ljava/lang/Object;Landroid/graphics/Rect;)V

    move-object/from16 v0, p0

    invoke-static {v0, v3}, Lc8/Ii;->add(Landroid/view/View;Ljava/lang/Runnable;)Lc8/Ii;
...
.method private static configureTransitionsOptimized(Landroid/support/v4/app/FragmentManagerImpl;ILc8/xi;Landroid/view/View;Landroid/support/v4/util/ArrayMap;)V
    .locals 22
    ...
    iget-object v0, v0, Lc8/xi;->lastIn:Landroid/support/v4/app/Fragment;
    ...
    iget-object v0, v0, Lc8/xi;->firstOut:Landroid/support/v4/app/Fragment;
    ...
    iget-boolean v0, v0, Lc8/xi;->lastInIsPop:Z
    ...
    iget-boolean v0, v0, Lc8/xi;->firstOutIsPop:Z
    ...
    .line 206
    invoke-static/range {v2 .. v9}, Landroid/support/v4/app/FragmentTransition;->configureSharedElementsOptimized(Landroid/view/ViewGroup;Landroid/view/View;Landroid/support/v4/util/ArrayMap;Lc8/xi;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method private static configureTransitionsUnoptimized(Landroid/support/v4/app/FragmentManagerImpl;ILc8/xi;Landroid/view/View;Landroid/support/v4/util/ArrayMap;)V
    .locals 27
    .param p0, "fragmentManager"    # Landroid/support/v4/app/FragmentManagerImpl;
    .param p1, "containerId"    # I
    .param p2, "fragments"    # Lc8/xi;
    ...
    .line 300
    invoke-static/range {v2 .. v9}, Landroid/support/v4/app/FragmentTransition;->configureSharedElementsUnoptimized(Landroid/view/ViewGroup;Landroid/view/View;Landroid/support/v4/util/ArrayMap;Lc8/xi;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-boolean v3, v0, Lc8/xi;->lastInIsPop:Z
...
.method private static ensureContainer(Lc8/xi;Landroid/util/SparseArray;I)Lc8/xi;
    .locals 0
    .param p0, "containerTransition"    # Lc8/xi;
    ...
    .line 1111
    new-instance p0, Lc8/xi;

    .end local p0    # "containerTransition":Lc8/xi;
    invoke-direct {p0}, Lc8/xi;-><init>()V

    .line 1112
    .restart local p0    # "containerTransition":Lc8/xi;
...
.method private static getInEpicenterView(Landroid/support/v4/util/ArrayMap;Lc8/xi;Ljava/lang/Object;Z)Landroid/view/View;
    .locals 4
    .param p1, "fragments"    # Lc8/xi;
    ...
    .line 813
    iget-object v0, p1, Lc8/xi;->lastInTransaction:Landroid/support/v4/app/BackStackRecord;
...
.method private static replaceHide(Ljava/lang/Object;Landroid/support/v4/app/Fragment;Ljava/util/ArrayList;)V
    ...
    new-instance v1, Lc8/ti;

    invoke-direct {v1, p2}, Lc8/ti;-><init>(Ljava/util/ArrayList;)V

    invoke-static {v0, v1}, Lc8/Ii;->add(Landroid/view/View;Ljava/lang/Runnable;)Lc8/Ii;
...
.method private static scheduleTargetChange(Landroid/view/ViewGroup;Landroid/support/v4/app/Fragment;Landroid/view/View;Ljava/util/ArrayList;Ljava/lang/Object;Ljava/util/ArrayList;Ljava/lang/Object;Ljava/util/ArrayList;)V
    ...
    invoke-direct/range {v0 .. v7}, Lc8/ui;-><init>(Ljava/lang/Object;Landroid/view/View;Landroid/support/v4/app/Fragment;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/lang/Object;)V

    invoke-static {p0, v0}, Lc8/Ii;->add(Landroid/view/View;Ljava/lang/Runnable;)Lc8/Ii;
...
.method static startTransitions(Landroid/support/v4/app/FragmentManagerImpl;Ljava/util/ArrayList;Ljava/util/ArrayList;IIZ)V
    ...
    check-cast v2, Lc8/xi;

    .line 109
    .local v2, "containerTransition":Lc8/xi;
    if-eqz p5, :cond_4

    .line 110
    invoke-static {p0, v1, v2, v6, v5}, Landroid/support/v4/app/FragmentTransition;->configureTransitionsOptimized(Landroid/support/v4/app/FragmentManagerImpl;ILc8/xi;Landroid/view/View;Landroid/support/v4/util/ArrayMap;)V
    ...
    .line 113
    :cond_4
    invoke-static {p0, v1, v2, v6, v5}, Landroid/support/v4/app/FragmentTransition;->configureTransitionsUnoptimized(Landroid/support/v4/app/FragmentManagerImpl;ILc8/xi;Landroid/view/View;Landroid/support/v4/util/ArrayMap;)V
