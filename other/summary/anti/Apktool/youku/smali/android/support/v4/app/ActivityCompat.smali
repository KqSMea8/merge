...
.method private static createCallback(Landroid/support/v4/app/SharedElementCallback;)Lc8/ai;
    .locals 1
    ...
    .line 430
    .restart local v0    # "newCallback":Lc8/ai;
    :cond_0
    return-object v0
.end method

.method private static createCallback23(Landroid/support/v4/app/SharedElementCallback;)Lc8/fi;
    .locals 1
    .param p0, "callback"    # Landroid/support/v4/app/SharedElementCallback;
    ...
    .line 436
    .local v0, "newCallback":Lc8/fi;
    if-eqz p0, :cond_0

    .line 437
    new-instance v0, Lc8/Zh;

    .end local v0    # "newCallback":Lc8/fi;
    invoke-direct {v0, p0}, Lc8/Zh;-><init>(Landroid/support/v4/app/SharedElementCallback;)V

    .line 439
    .restart local v0    # "newCallback":Lc8/fi;
    :cond_0
    return-object v0
.end method
...
.method public static finishAfterTransition(Landroid/app/Activity;)V
    ...
    .line 216
    invoke-static {p0}, Lc8/ci;->finishAfterTransition(Landroid/app/Activity;)V
...
.method public static getReferrer(Landroid/app/Activity;)Landroid/net/Uri;
    ...
    .line 241
    invoke-static {p0}, Lc8/di;->getReferrer(Landroid/app/Activity;)Landroid/net/Uri;
...
.method public static postponeEnterTransition(Landroid/app/Activity;)V
    ...
    .line 292
    invoke-static {p0}, Lc8/ci;->postponeEnterTransition(Landroid/app/Activity;)V
...
.method public static setEnterSharedElementCallback(Landroid/app/Activity;Landroid/support/v4/app/SharedElementCallback;)V
    ...
    .line 266
    invoke-static {p1}, Landroid/support/v4/app/ActivityCompat;->createCallback23(Landroid/support/v4/app/SharedElementCallback;)Lc8/fi;

    move-result-object v0

    invoke-static {p0, v0}, Landroid/support/v4/app/ActivityCompatApi23;->setEnterSharedElementCallback(Landroid/app/Activity;Lc8/fi;)V
    ...
    .line 268
    invoke-static {p1}, Landroid/support/v4/app/ActivityCompat;->createCallback(Landroid/support/v4/app/SharedElementCallback;)Lc8/ai;

    move-result-object v0

    invoke-static {p0, v0}, Lc8/ci;->setEnterSharedElementCallback(Landroid/app/Activity;Lc8/ai;)V
...
.method public static setExitSharedElementCallback(Landroid/app/Activity;Landroid/support/v4/app/SharedElementCallback;)V
    ...
    invoke-static {p0, v0}, Landroid/support/v4/app/ActivityCompatApi23;->setExitSharedElementCallback(Landroid/app/Activity;Lc8/fi;)V
    ...
    invoke-static {p0, v0}, Lc8/ci;->setExitSharedElementCallback(Landroid/app/Activity;Lc8/ai;)V
...
.method public static startPostponedEnterTransition(Landroid/app/Activity;)V
    ...
    .line 298
    invoke-static {p0}, Lc8/ci;->startPostponedEnterTransition(Landroid/app/Activity;)V
