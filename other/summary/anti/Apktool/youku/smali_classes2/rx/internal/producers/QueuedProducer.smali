...
.method public constructor <init>(Lc8/Omq;)V
    ...
    :goto_0
    invoke-direct {p0, p1, v0}, Lrx/internal/producers/QueuedProducer;-><init>(Lc8/Omq;Ljava/util/Queue;)V
...
.method public constructor <init>(Lc8/Omq;Ljava/util/Queue;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 62
    iput-object p1, p0, Lrx/internal/producers/QueuedProducer;->child:Lc8/Omq;
...
.method private checkTerminated(ZZ)Z
    ...
    .line 120
    iget-object v2, p0, Lrx/internal/producers/QueuedProducer;->child:Lc8/Omq;
...
.method private drain()V
    ...
    .line 140
    iget-object v0, p0, Lrx/internal/producers/QueuedProducer;->child:Lc8/Omq;

    .line 141
    .local v0, "c":Lc8/Omq;, "Lrx/Subscriber<-TT;>;"
    ...
    .line 184
    .end local v0    # "c":Lc8/Omq;, "Lrx/Subscriber<-TT;>;"
    ...
    .line 148
    .restart local v0    # "c":Lc8/Omq;, "Lrx/Subscriber<-TT;>;"
    ...
    invoke-virtual {v0, v8}, Lc8/Omq;->onNext(Ljava/lang/Object;)V
    :try_end_0
    ...
    :goto_4
    invoke-static {v4, v0, v9}, Lc8/fnq;->throwOrReport(Ljava/lang/Throwable;Lc8/Wlq;Ljava/lang/Object;)V
