...
.method private static makesureFileExist(Ljava/lang/String;)V
    ...
    .line 343
    invoke-static {v1}, Lc8/pye;->isParentExist(Ljava/io/File;)Z
    ...
    .line 345
    invoke-static {v1}, Lc8/pye;->delete(Ljava/io/File;)V
...
.method private static revitionImageSize(Ljava/lang/String;II)V
    ...
    .line 145
    :cond_0
    invoke-static {p0}, Lc8/pye;->isFileExisted(Ljava/lang/String;)Z
    ...
    :cond_2
    invoke-static {p0}, Lc8/oye;->verifyBitmap(Ljava/lang/String;)Z
    ...
    .line 174
    invoke-static {p0, v3}, Lc8/pye;->safeDecodeBimtapFile(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    :cond_5
    invoke-static {p0}, Lc8/pye;->deleteDependon(Ljava/lang/String;)Z

    .line 181
    invoke-static {p0}, Lc8/pye;->makesureFileExist(Ljava/lang/String;)V
...
.method private static revitionImageSizeHD(Ljava/lang/String;II)V
    ...
    .line 54
    :cond_0
    invoke-static/range {p0 .. p0}, Lc8/pye;->isFileExisted(Ljava/lang/String;)Z
    ...
    .restart local p0    # "picfile":Ljava/lang/String;
    :cond_2
    invoke-static/range {p0 .. p0}, Lc8/oye;->verifyBitmap(Ljava/lang/String;)Z
    ...
    invoke-static {v0, v8}, Lc8/pye;->safeDecodeBimtapFile(Ljava/lang/String;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    :cond_5
    invoke-static/range {p0 .. p0}, Lc8/pye;->deleteDependon(Ljava/lang/String;)Z

    .line 91
    invoke-static/range {p0 .. p0}, Lc8/pye;->makesureFileExist(Ljava/lang/String;)V
...
.method public static revitionPostImageSize(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    .line 207
    :try_start_0
    invoke-static {p0}, Lc8/sye;->isWifiValid(Landroid/content/Context;)Z
    ...
    invoke-static {p1, v1, v2}, Lc8/pye;->revitionImageSizeHD(Ljava/lang/String;II)V
    ...
    invoke-static {p1, v1, v2}, Lc8/pye;->revitionImageSize(Ljava/lang/String;II)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
