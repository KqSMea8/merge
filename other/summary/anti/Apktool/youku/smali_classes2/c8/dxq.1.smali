...
# static fields
.field public static final INSTANCE:Lc8/dxq;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lc8/dxq;->NONE:[Ljava/util/concurrent/ScheduledExecutorService;
    ...
    .line 39
    sput-object v0, Lc8/dxq;->SHUTDOWN:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    sput-object v0, Lc8/dxq;->INSTANCE:Lc8/dxq;
...
.method private constructor <init>()V
    ...
    sget-object v1, Lc8/dxq;->NONE:[Ljava/util/concurrent/ScheduledExecutorService;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicReference;-><init>(Ljava/lang/Object;)V

    iput-object v0, p0, Lc8/dxq;->executor:Ljava/util/concurrent/atomic/AtomicReference;

    .line 52
    invoke-virtual {p0}, Lc8/dxq;->start()V
...
.method public static getInstance()Ljava/util/concurrent/ScheduledExecutorService;
    ...
    .prologue
    .line 111
    sget-object v2, Lc8/dxq;->INSTANCE:Lc8/dxq;

    iget-object v2, v2, Lc8/dxq;->executor:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    sget-object v2, Lc8/dxq;->NONE:[Ljava/util/concurrent/ScheduledExecutorService;

    if-ne v0, v2, :cond_0

    .line 113
    sget-object v2, Lc8/dxq;->SHUTDOWN:Ljava/util/concurrent/ScheduledExecutorService;
...
.method public shutdown()V
    ...
    .line 91
    :cond_0
    iget-object v5, p0, Lc8/dxq;->executor:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    sget-object v5, Lc8/dxq;->NONE:[Ljava/util/concurrent/ScheduledExecutorService;
    ...
    sget-object v6, Lc8/dxq;->NONE:[Ljava/util/concurrent/ScheduledExecutorService;
    ...
    invoke-static {v1}, Lc8/jxq;->deregisterExecutor(Ljava/util/concurrent/ScheduledExecutorService;)V
...
.method public start()V
    ...
    .line 73
    :cond_2
    iget-object v7, p0, Lc8/dxq;->executor:Ljava/util/concurrent/atomic/AtomicReference;

    sget-object v8, Lc8/dxq;->NONE:[Ljava/util/concurrent/ScheduledExecutorService;
    ...
    invoke-static {v2}, Lc8/jxq;->tryEnableCancelPolicy(Ljava/util/concurrent/ScheduledExecutorService;)Z
