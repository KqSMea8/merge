...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-boolean v0, Lc8/ucq;->$assertionsDisabled:Z
    ...
    sput-object v0, Lc8/ucq;->emptybuffer:Ljava/nio/ByteBuffer;
...
.method public constructor <init>(Ljava/nio/channels/SocketChannel;Ljavax/net/ssl/SSLEngine;Ljava/util/concurrent/ExecutorService;Ljava/nio/channels/SelectionKey;)V
    ...
    .line 63
    iput v3, p0, Lc8/ucq;->bufferallocations:I
    ...
    .line 69
    :cond_1
    iput-object p1, p0, Lc8/ucq;->socketChannel:Ljava/nio/channels/SocketChannel;

    .line 70
    iput-object p2, p0, Lc8/ucq;->sslEngine:Ljavax/net/ssl/SSLEngine;

    .line 71
    iput-object p3, p0, Lc8/ucq;->exec:Ljava/util/concurrent/ExecutorService;
    ...
    iput-object v0, p0, Lc8/ucq;->writeEngineResult:Ljavax/net/ssl/SSLEngineResult;

    iput-object v0, p0, Lc8/ucq;->readEngineResult:Ljavax/net/ssl/SSLEngineResult;
    ...
    iput-object v0, p0, Lc8/ucq;->tasks:Ljava/util/List;
    ...
    .line 78
    iput-object p4, p0, Lc8/ucq;->selectionKey:Ljava/nio/channels/SelectionKey;
    ...
    invoke-virtual {p0, v0}, Lc8/ucq;->createBuffers(Ljavax/net/ssl/SSLSession;)V

    .line 82
    iget-object v0, p0, Lc8/ucq;->socketChannel:Ljava/nio/channels/SocketChannel;

    sget-object v1, Lc8/ucq;->emptybuffer:Ljava/nio/ByteBuffer;

    invoke-direct {p0, v1}, Lc8/ucq;->wrap(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    .line 83
    invoke-direct {p0}, Lc8/ucq;->processHandshake()V
...
.method private isHandShakeComplete()Z
    ...
    .prologue
    .line 315
    iget-object v1, p0, Lc8/ucq;->sslEngine:Ljavax/net/ssl/SSLEngine;
...
.method private declared-synchronized processHandshake()V
    ...
    :try_start_0
    iget-object v3, p0, Lc8/ucq;->sslEngine:Ljavax/net/ssl/SSLEngine;
    ...
    :cond_1
    :try_start_1
    iget-object v3, p0, Lc8/ucq;->tasks:Ljava/util/List;
    ...
    :cond_2
    :try_start_2
    invoke-virtual {p0}, Lc8/ucq;->isBlocking()Z
    ...
    .line 119
    invoke-direct {p0, v0}, Lc8/ucq;->consumeFutureUninterruptible(Ljava/util/concurrent/Future;)V
    ...
    iget-object v3, p0, Lc8/ucq;->readEngineResult:Ljavax/net/ssl/SSLEngineResult;
    ...
    .line 127
    :cond_4
    iget-object v3, p0, Lc8/ucq;->inCrypt:Ljava/nio/ByteBuffer;

    invoke-virtual {v3}, Ljava/nio/ByteBuffer;->compact()Ljava/nio/ByteBuffer;

    .line 128
    iget-object v3, p0, Lc8/ucq;->socketChannel:Ljava/nio/channels/SocketChannel;

    iget-object v4, p0, Lc8/ucq;->inCrypt:Ljava/nio/ByteBuffer;
    ...
    const-string/jumbo v4, "connection closed unexpectedly by peer"
    ...
    .end local v2    # "read":I
    :cond_6
    iget-object v3, p0, Lc8/ucq;->inData:Ljava/nio/ByteBuffer;

    invoke-virtual {v3}, Ljava/nio/ByteBuffer;->compact()Ljava/nio/ByteBuffer;

    .line 135
    invoke-direct {p0}, Lc8/ucq;->unwrap()Ljava/nio/ByteBuffer;
    ...
    invoke-virtual {p0, v3}, Lc8/ucq;->createBuffers(Ljavax/net/ssl/SSLSession;)V

    goto/16 :goto_0

    .line 141
    :cond_7
    invoke-virtual {p0}, Lc8/ucq;->consumeDelegatedTasks()V
    ...
    sget-object v4, Lc8/ucq;->emptybuffer:Ljava/nio/ByteBuffer;

    invoke-direct {p0, v4}, Lc8/ucq;->wrap(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    .line 144
    iget-object v3, p0, Lc8/ucq;->writeEngineResult:Ljavax/net/ssl/SSLEngineResult;
    ...
    .line 149
    :cond_9
    sget-boolean v3, Lc8/ucq;->$assertionsDisabled:Z
...
.method private readRemaining(Ljava/nio/ByteBuffer;)I
    ...
    .prologue
    .line 283
    iget-object v1, p0, Lc8/ucq;->inData:Ljava/nio/ByteBuffer;
    ...
    invoke-direct {p0, v1, p1}, Lc8/ucq;->transfereTo(Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;)I
    ...
    .line 289
    :cond_2
    iget-object v1, p0, Lc8/ucq;->inCrypt:Ljava/nio/ByteBuffer;
    ...
    .line 292
    .local v0, "amount":I
    iget-object v1, p0, Lc8/ucq;->readEngineResult:Ljavax/net/ssl/SSLEngineResult;
...
.method private declared-synchronized unwrap()Ljava/nio/ByteBuffer;
    ...
    iget-object v2, p0, Lc8/ucq;->inCrypt:Ljava/nio/ByteBuffer;
    ...
    iput-object v1, p0, Lc8/ucq;->readEngineResult:Ljavax/net/ssl/SSLEngineResult;
...
.method private declared-synchronized wrap(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    :try_start_0
    iget-object v0, p0, Lc8/ucq;->outCrypt:Ljava/nio/ByteBuffer;

    invoke-virtual {v0}, Ljava/nio/ByteBuffer;->compact()Ljava/nio/ByteBuffer;

    .line 155
    iget-object v0, p0, Lc8/ucq;->sslEngine:Ljavax/net/ssl/SSLEngine;

    iget-object v1, p0, Lc8/ucq;->outCrypt:Ljava/nio/ByteBuffer;
...
.method public close()V
    ...
    .line 311
    iget-object v0, p0, Lc8/ucq;->exec:Ljava/util/concurrent/ExecutorService;
...
.method protected consumeDelegatedTasks()V
    ...
    .line 176
    iget-object v1, p0, Lc8/ucq;->tasks:Ljava/util/List;

    iget-object v2, p0, Lc8/ucq;->exec:Ljava/util/concurrent/ExecutorService;
...
.method protected createBuffers(Ljavax/net/ssl/SSLSession;)V
    ...
    iget-object v2, p0, Lc8/ucq;->inData:Ljava/nio/ByteBuffer;
    ...
    iput-object v2, p0, Lc8/ucq;->inData:Ljava/nio/ByteBuffer;
    ...
    iput-object v2, p0, Lc8/ucq;->outCrypt:Ljava/nio/ByteBuffer;
    ...
    iput-object v2, p0, Lc8/ucq;->inCrypt:Ljava/nio/ByteBuffer;
    ...
    .line 201
    iget-object v2, p0, Lc8/ucq;->outCrypt:Ljava/nio/ByteBuffer;
    ...
    .line 203
    iget v2, p0, Lc8/ucq;->bufferallocations:I

    add-int/lit8 v2, v2, 0x1

    iput v2, p0, Lc8/ucq;->bufferallocations:I
...
.method public isNeedRead()Z
    ...
    .prologue
    .line 356
    iget-object v0, p0, Lc8/ucq;->inData:Ljava/nio/ByteBuffer;
    ...
    iget-object v0, p0, Lc8/ucq;->inCrypt:Ljava/nio/ByteBuffer;
    ...
    iget-object v0, p0, Lc8/ucq;->readEngineResult:Ljavax/net/ssl/SSLEngineResult;
...
.method public isNeedWrite()Z
    ...
    invoke-direct {p0}, Lc8/ucq;->isHandShakeComplete()Z
...
.method public read(Ljava/nio/ByteBuffer;)I
    ...
    .line 251
    :cond_3
    invoke-direct {p0, p1}, Lc8/ucq;->readRemaining(Ljava/nio/ByteBuffer;)I
    ...
    .line 258
    sget-boolean v2, Lc8/ucq;->$assertionsDisabled:Z
    ...
    iget-object v2, p0, Lc8/ucq;->readEngineResult:Ljavax/net/ssl/SSLEngineResult;
    ...
    .line 267
    :cond_5
    iget-object v2, p0, Lc8/ucq;->socketChannel:Ljava/nio/channels/SocketChannel;
    ...
    invoke-direct {p0, v2, p1}, Lc8/ucq;->transfereTo(Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;)I
    ...
    .line 275
    invoke-virtual {p0, p1}, Lc8/ucq;->read(Ljava/nio/ByteBuffer;)I
...
.method public write(Ljava/nio/ByteBuffer;)I
    ...
    .line 215
    :cond_1
    iget-object v1, p0, Lc8/ucq;->socketChannel:Ljava/nio/channels/SocketChannel;

    invoke-direct {p0, p1}, Lc8/ucq;->wrap(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;
    ...
    .line 216
    .local v0, "num":I
    iget-object v1, p0, Lc8/ucq;->writeEngineResult:Ljavax/net/ssl/SSLEngineResult;
...
.method public writeMore()V
    ...
    invoke-virtual {p0, v0}, Lc8/ucq;->write(Ljava/nio/ByteBuffer;)I
