...
.method public constructor <init>(IJLc8/amq;)V
    ...
    .prologue
    .line 962
    .local p0, "this":Lc8/ABq;, "Lrx/subjects/ReplaySubject$ReplaySizeAndTimeBoundBuffer<TT;>;"
    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    .line 963
    iput p1, p0, Lc8/ABq;->limit:I
    ...
    iput-object v0, p0, Lc8/ABq;->tail:Lrx/subjects/ReplaySubject$ReplaySizeAndTimeBoundBuffer$TimedNode;

    .line 966
    iput-object v0, p0, Lc8/ABq;->head:Lrx/subjects/ReplaySubject$ReplaySizeAndTimeBoundBuffer$TimedNode;

    .line 967
    iput-wide p2, p0, Lc8/ABq;->maxAgeMillis:J

    .line 968
    iput-object p4, p0, Lc8/ABq;->scheduler:Lc8/amq;
...
.method public complete()V
    ...
    .line 1013
    .local p0, "this":Lc8/ABq;, "Lrx/subjects/ReplaySubject$ReplaySizeAndTimeBoundBuffer<TT;>;"
    invoke-virtual {p0}, Lc8/ABq;->evictFinal()V

    .line 1014
    const/4 v0, 0x1

    iput-boolean v0, p0, Lc8/ABq;->done:Z
...
.method public drain(Lrx/subjects/ReplaySubject$ReplayProducer;)V
    ...
    .line 1055
    :cond_0
    iget-object v0, p1, Lrx/subjects/ReplaySubject$ReplayProducer;->actual:Lc8/Omq;
    ...
    .line 1067
    invoke-virtual {p0}, Lc8/ABq;->latestHead()Lrx/subjects/ReplaySubject$ReplaySizeAndTimeBoundBuffer$TimedNode;
    ...
    .line 1076
    :cond_3
    iget-boolean v1, p0, Lc8/ABq;->done:Z
    ...
    .line 1082
    iget-object v5, p0, Lc8/ABq;->error:Ljava/lang/Throwable;
    ...
    .line 1084
    invoke-virtual {v0, v5}, Lc8/Omq;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-static {v9, v2, v3}, Lc8/ioq;->produced(Ljava/util/concurrent/atomic/AtomicLong;J)J
...
.method public error()Ljava/lang/Throwable;
    ...
    .line 1158
    .local p0, "this":Lc8/ABq;, "Lrx/subjects/ReplaySubject$ReplaySizeAndTimeBoundBuffer<TT;>;"
    iget-object v0, p0, Lc8/ABq;->error:Ljava/lang/Throwable;
...
.method public error(Ljava/lang/Throwable;)V
    ...
    .line 1007
    iput-object p1, p0, Lc8/ABq;->error:Ljava/lang/Throwable;
...
.method evictFinal()V
    ...
    .line 1018
    .local p0, "this":Lc8/ABq;, "Lrx/subjects/ReplaySubject$ReplaySizeAndTimeBoundBuffer<TT;>;"
    iget-object v3, p0, Lc8/ABq;->scheduler:Lc8/amq;

    invoke-virtual {v3}, Lc8/amq;->now()J

    move-result-wide v6

    iget-wide v8, p0, Lc8/ABq;->maxAgeMillis:J

    sub-long v4, v6, v8

    .line 1020
    .local v4, "now":J
    iget-object v1, p0, Lc8/ABq;->head:Lrx/subjects/ReplaySubject$ReplaySizeAndTimeBoundBuffer$TimedNode;
...
.method public isComplete()Z
    ...
    .line 1153
    .local p0, "this":Lc8/ABq;, "Lrx/subjects/ReplaySubject$ReplaySizeAndTimeBoundBuffer<TT;>;"
    iget-boolean v0, p0, Lc8/ABq;->done:Z
...
.method latestHead()Lrx/subjects/ReplaySubject$ReplaySizeAndTimeBoundBuffer$TimedNode;
    ...
    .line 1037
    .local p0, "this":Lc8/ABq;, "Lrx/subjects/ReplaySubject$ReplaySizeAndTimeBoundBuffer<TT;>;"
    iget-object v4, p0, Lc8/ABq;->scheduler:Lc8/amq;

    invoke-virtual {v4}, Lc8/amq;->now()J

    move-result-wide v4

    iget-wide v6, p0, Lc8/ABq;->maxAgeMillis:J

    sub-long v2, v4, v6

    .line 1038
    .local v2, "now":J
    iget-object v0, p0, Lc8/ABq;->head:Lrx/subjects/ReplaySubject$ReplaySizeAndTimeBoundBuffer$TimedNode;
...
.method public next(Ljava/lang/Object;)V
    ...
    iget-object v6, p0, Lc8/ABq;->scheduler:Lc8/amq;
    ...
    .line 976
    .local v2, "n":Lrx/subjects/ReplaySubject$ReplaySizeAndTimeBoundBuffer$TimedNode;, "Lrx/subjects/ReplaySubject$ReplaySizeAndTimeBoundBuffer$TimedNode<TT;>;"
    iget-object v6, p0, Lc8/ABq;->tail:Lrx/subjects/ReplaySubject$ReplaySizeAndTimeBoundBuffer$TimedNode;

    invoke-virtual {v6, v2}, Lrx/subjects/ReplaySubject$ReplaySizeAndTimeBoundBuffer$TimedNode;->set(Ljava/lang/Object;)V

    .line 977
    iput-object v2, p0, Lc8/ABq;->tail:Lrx/subjects/ReplaySubject$ReplaySizeAndTimeBoundBuffer$TimedNode;
