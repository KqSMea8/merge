...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lc8/ATe;->EMPTY_BYTE_ARRAY:[B

    .line 45
    new-array v0, v1, [Ljava/lang/String;

    sput-object v0, Lc8/ATe;->EMPTY_STRING_ARRAY:[Ljava/lang/String;
    ...
    sput-object v0, Lc8/ATe;->UTF_8:Ljava/nio/charset/Charset;
...
.method public static discard(Lc8/uWp;ILjava/util/concurrent/TimeUnit;)Z
    .locals 1
    ...
    .line 141
    :try_start_0
    invoke-static {p0, p1, p2}, Lc8/ATe;->skipAll(Lc8/uWp;ILjava/util/concurrent/TimeUnit;)Z
    :try_end_0
...
.method public static hostHeader(Lc8/JSe;)Ljava/lang/String;
    .locals 2
    .param p0, "url"    # Lc8/JSe;

    .prologue
    .line 261
    invoke-virtual {p0}, Lc8/JSe;->port()I

    move-result v0

    invoke-virtual {p0}, Lc8/JSe;->scheme()Ljava/lang/String;

    move-result-object v1

    invoke-static {v1}, Lc8/JSe;->defaultPort(Ljava/lang/String;)I
    ...
    .line 262
    invoke-virtual {p0}, Lc8/JSe;->host()Ljava/lang/String;
...
.method public static intersect(Ljava/lang/Class;[Ljava/lang/Object;[Ljava/lang/Object;)[Ljava/lang/Object;
    ...
    invoke-static {p1, p2}, Lc8/ATe;->intersect([Ljava/lang/Object;[Ljava/lang/Object;)Ljava/util/List;
...
.method public static skipAll(Lc8/uWp;ILjava/util/concurrent/TimeUnit;)Z
    .locals 12
    .param p0, "source"    # Lc8/uWp;
    .param p1, "duration"    # I
    .param p2, "timeUnit"    # Ljava/util/concurrent/TimeUnit;
    ...
    .line 153
    .local v0, "now":J
    invoke-interface {p0}, Lc8/uWp;->timeout()Lc8/wWp;

    move-result-object v5

    invoke-virtual {v5}, Lc8/wWp;->hasDeadline()Z
    ...
    invoke-virtual {v5}, Lc8/wWp;->deadlineNanoTime()J
    ...
    invoke-virtual {v5, v8, v9}, Lc8/wWp;->deadlineNanoTime(J)Lc8/wWp;

    .line 158
    :try_start_0
    new-instance v4, Lc8/YVp;

    invoke-direct {v4}, Lc8/YVp;-><init>()V

    .line 159
    .local v4, "skipBuffer":Lc8/YVp;
    :goto_1
    const-wide/16 v8, 0x800

    invoke-interface {p0, v4, v8, v9}, Lc8/uWp;->read(Lc8/YVp;J)J
    ...
    .line 160
    invoke-virtual {v4}, Lc8/YVp;->clear()V
    :try_end_0
    ...
    .line 164
    .end local v4    # "skipBuffer":Lc8/YVp;
    :catch_0
    move-exception v5
    ...
    invoke-virtual {v6}, Lc8/wWp;->clearDeadline()Lc8/wWp;
    ...
    .restart local v4    # "skipBuffer":Lc8/YVp;
    :cond_1
    const/4 v5, 0x1
    ...
    invoke-virtual {v6, v8, v9}, Lc8/wWp;->deadlineNanoTime(J)Lc8/wWp;
...
.method public static threadFactory(Ljava/lang/String;Z)Ljava/util/concurrent/ThreadFactory;
    ...
    .prologue
    .line 223
    new-instance v0, Lc8/zTe;

    invoke-direct {v0, p0, p1}, Lc8/zTe;-><init>(Ljava/lang/String;Z)V
...
.method public static toHumanReadableAscii(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v0, p0, v5, v2}, Lc8/YVp;->writeUtf8(Ljava/lang/String;II)Lc8/YVp;
    ...
    :goto_2
    invoke-virtual {v0, v5}, Lc8/YVp;->writeUtf8CodePoint(I)Lc8/YVp;
