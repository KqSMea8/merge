...
.method public execute(Lc8/Vhq;)Lc8/Whq;
    ...
    .prologue
    .line 36
    invoke-virtual {p0, p1}, Lc8/Zhq;->openConnection(Lc8/Vhq;)Ljava/net/HttpURLConnection;

    move-result-object v0

    .line 37
    .local v0, "connection":Ljava/net/HttpURLConnection;
    invoke-virtual {p0, v0, p1}, Lc8/Zhq;->prepareRequest(Ljava/net/HttpURLConnection;Lc8/Vhq;)V

    .line 38
    invoke-virtual {p0, v0}, Lc8/Zhq;->readResponse(Ljava/net/HttpURLConnection;)Lc8/Whq;
...
.method protected openConnection(Lc8/Vhq;)Ljava/net/HttpURLConnection;
    .locals 3
    .param p1, "request"    # Lc8/Vhq;
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method prepareRequest(Ljava/net/HttpURLConnection;Lc8/Vhq;)V
    .locals 8
    ...
    .line 50
    invoke-virtual {p2}, Lc8/Vhq;->getMethod()Ljava/lang/String;
    ...
    .line 53
    invoke-virtual {p2}, Lc8/Vhq;->getHeaders()Ljava/util/List;
    ...
    invoke-interface {v0}, Lc8/Hiq;->mimeType()Ljava/lang/String;
    ...
    invoke-interface {v0, v4}, Lc8/Hiq;->writeTo(Ljava/io/OutputStream;)V
...
.method readResponse(Ljava/net/HttpURLConnection;)Lc8/Whq;
    .locals 15
    .param p1, "connection"    # Ljava/net/HttpURLConnection;
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    new-instance v5, Lc8/Rhq;

    invoke-direct {v5, v13, v14}, Lc8/Rhq;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :goto_1
    new-instance v0, Lc8/Yhq;

    int-to-long v2, v12

    const/4 v5, 0x0

    invoke-direct/range {v0 .. v5}, Lc8/Yhq;-><init>(Ljava/lang/String;JLjava/io/InputStream;Lc8/Xhq;)V

    .line 94
    .local v0, "responseBody":Lc8/Giq;
    new-instance v5, Lc8/Whq;
    ...
    invoke-direct/range {v5 .. v10}, Lc8/Whq;-><init>(Ljava/lang/String;ILjava/lang/String;Ljava/util/List;Lc8/Giq;)V

    return-object v5

    .line 91
    .end local v0    # "responseBody":Lc8/Giq;
