.class public Lc8/Gbp;
.super Landroid/widget/ImageView;
.source "YoukuLandImageView.java"
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lc8/Gbp;->BITMAP_CONFIG:Landroid/graphics/Bitmap$Config;
...
.method private drawDrawable(Landroid/graphics/Canvas;Landroid/graphics/Bitmap;)V
    ...
    invoke-virtual/range {p0 .. p0}, Lc8/Gbp;->getWidth()I

    move-result v3

    int-to-float v6, v3

    invoke-virtual/range {p0 .. p0}, Lc8/Gbp;->getHeight()I
...
.method private getBitmapFromDrawable(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Bitmap;
    ...
    sget-object v5, Lc8/Gbp;->BITMAP_CONFIG:Landroid/graphics/Bitmap$Config;
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    .prologue
    .line 46
    invoke-virtual {p0}, Lc8/Gbp;->getDrawable()Landroid/graphics/drawable/Drawable;
    ...
    .line 51
    :cond_1
    invoke-virtual {p0}, Lc8/Gbp;->getWidth()I

    move-result v2

    if-eqz v2, :cond_0

    invoke-virtual {p0}, Lc8/Gbp;->getHeight()I
    ...
    .line 58
    invoke-direct {p0, v1}, Lc8/Gbp;->getBitmapFromDrawable(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Bitmap;

    move-result-object v0

    .line 59
    .local v0, "bitmap":Landroid/graphics/Bitmap;
    invoke-direct {p0, p1, v0}, Lc8/Gbp;->drawDrawable(Landroid/graphics/Canvas;Landroid/graphics/Bitmap;)V
...
.method protected onMeasure(II)V
    ...
    .line 39
    .local v0, "h":I
    invoke-virtual {p0, v1, v0}, Lc8/Gbp;->setMeasuredDimension(II)V
