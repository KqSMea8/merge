...
.field public static final APLUS_BASE_URL:Ljava/lang/String; = "http://wgo.mmstat.com/%s"
...
.method public static declared-synchronized getApplication()Landroid/app/Application;
    ...
    const-class v1, Lc8/Eff;

    monitor-enter v1

    :try_start_0
    sget-object v0, Lc8/Eff;->sApplication:Landroid/app/Application;

    if-nez v0, :cond_0

    invoke-static {}, Lc8/Eff;->getSystemApp()Landroid/app/Application;

    move-result-object v0

    sput-object v0, Lc8/Eff;->sApplication:Landroid/app/Application;
...
.method public static getClientUrl()Ljava/lang/String;
    ...
    const-string/jumbo v0, "http://wgo.mmstat.com/%s"
    ...
    const-string/jumbo v3, "minitrade.1.200.1"
...
.method public static getConfigUrl()Ljava/lang/String;
    ...
    const-string/jumbo v3, "minitrade.1.200.2"
...
.method public static getCrashUrl()Ljava/lang/String;
    ...
    const-string/jumbo v3, "minitrade.1.200.3"
...
.method public static getNoneClientUrl()Ljava/lang/String;
    ...
    const-string/jumbo v3, "minitrade.1.200.4"
...
.method public static getServerAction(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v0, "com.taobao.open.intent.action.AUTH"
    ...
    const-string/jumbo v0, "com.tmall.wireless.intent.action.AUTH"
...
.method private static getSystemApp()Landroid/app/Application;
    ...
    invoke-static {v0}, Lc8/Eff;->_1forName(Ljava/lang/String;)Ljava/lang/Class;
    ...
    invoke-static {v2, v3, v4}, Lc8/Eff;->_2invoke(Ljava/lang/reflect/Method;Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static isSupportAppLinkSDK(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-static {p0}, Lc8/Eff;->isSupportTaobao(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Lc8/Eff;->isSupportTmall(Landroid/content/Context;)Z
