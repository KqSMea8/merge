...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lc8/qWf;->sDateFormatter:Ljava/text/SimpleDateFormat;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-wide v0, p0, Lc8/qWf;->mMaximumDatabaseSize:J

    .line 69
    iput-object p1, p0, Lc8/qWf;->mContext:Landroid/content/Context;
...
.method private deleteDB()Z
    ...
    .prologue
    .line 190
    invoke-virtual {p0}, Lc8/qWf;->closeDatabase()V

    .line 191
    iget-object v0, p0, Lc8/qWf;->mContext:Landroid/content/Context;
...
.method public closeDatabase()V
    ...
    .prologue
    .line 195
    iget-object v0, p0, Lc8/qWf;->mDb:Landroid/database/sqlite/SQLiteDatabase;
    ...
    iput-object v0, p0, Lc8/qWf;->mDb:Landroid/database/sqlite/SQLiteDatabase;
...
.method declared-synchronized ensureDatabase()V
    ...
    :try_start_0
    iget-object v2, p0, Lc8/qWf;->mDb:Landroid/database/sqlite/SQLiteDatabase;
    ...
    .line 159
    :try_start_1
    invoke-direct {p0}, Lc8/qWf;->deleteDB()Z

    .line 161
    :cond_2
    invoke-virtual {p0}, Lc8/qWf;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;

    move-result-object v2

    iput-object v2, p0, Lc8/qWf;->mDb:Landroid/database/sqlite/SQLiteDatabase;
    :try_end_1
    ...
    invoke-direct {p0, v2}, Lc8/qWf;->createTableIfNotExists(Landroid/database/sqlite/SQLiteDatabase;)V

    .line 179
    iget-object v2, p0, Lc8/qWf;->mDb:Landroid/database/sqlite/SQLiteDatabase;

    iget-wide v4, p0, Lc8/qWf;->mMaximumDatabaseSize:J
...
.method public getDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    .prologue
    .line 78
    invoke-virtual {p0}, Lc8/qWf;->ensureDatabase()V
...
.method public onUpgrade(Landroid/database/sqlite/SQLiteDatabase;II)V
    ...
    sget-object v10, Lc8/qWf;->sDateFormatter:Ljava/text/SimpleDateFormat;
    ...
    .line 138
    invoke-virtual {p0, p1}, Lc8/qWf;->onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
...
.method public declared-synchronized setMaximumSize(J)V
    ...
    :try_start_0
    iput-wide p1, p0, Lc8/qWf;->mMaximumDatabaseSize:J
    ...
    iget-wide v2, p0, Lc8/qWf;->mMaximumDatabaseSize:J
