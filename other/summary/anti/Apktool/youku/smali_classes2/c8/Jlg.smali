...
.method constructor <init>(Lc8/Mlg;)V
    ...
    .prologue
    .line 346
    iput-object p1, p0, Lc8/Jlg;->a:Lc8/Mlg;
...
.method public run()V
    ...
    .line 351
    :try_start_0
    iget-object v0, p0, Lc8/Jlg;->a:Lc8/Mlg;

    invoke-virtual {v0}, Lc8/Mlg;->c()Landroid/os/Bundle;
    ...
    invoke-static {v2, v5, v6}, Lc8/cmg;->getHttpClient(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Lorg/apache/http/client/HttpClient;
    ...
    .line 372
    invoke-static {v4}, Lc8/cmg;->encodeUrl(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    invoke-static {v5, v6}, Lc8/vlg;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v5}, Lc8/Flg;->b(Ljava/lang/String;)V
    :try_end_1
    ...
    iget-object v2, p0, Lc8/Jlg;->a:Lc8/Mlg;

    iget-object v2, v2, Lc8/Mlg;->c:Ljava/util/List;

    invoke-virtual {v0, v1, v2}, Lc8/Flg;->a(Ljava/lang/String;Ljava/util/List;)V
    ...
    invoke-static {v5, v6, v2}, Lc8/vlg;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
