...
.method static constructor <clinit>()V
    ...
    sput-object v2, Lc8/jxq;->SET_REMOVE_ON_CANCEL_POLICY_METHOD_NOT_SUPPORTED:Ljava/lang/Object;
    ...
    sput-object v2, Lc8/jxq;->EXECUTORS:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    sput-object v2, Lc8/jxq;->PURGE:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    sput v2, Lc8/jxq;->PURGE_FREQUENCY:I
    ...
    invoke-static {}, Lc8/cyq;->getAndroidApiVersion()I
    ...
    :goto_0
    sput-boolean v2, Lc8/jxq;->SHOULD_TRY_ENABLE_CANCEL_POLICY:Z
...
.method public constructor <init>(Ljava/util/concurrent/ThreadFactory;)V
    ...
    invoke-static {v1}, Lc8/jxq;->tryEnableCancelPolicy(Ljava/util/concurrent/ScheduledExecutorService;)Z
    ...
    invoke-static {v2}, Lc8/jxq;->registerExecutor(Ljava/util/concurrent/ScheduledThreadPoolExecutor;)V

    .line 214
    :cond_0
    iput-object v1, p0, Lc8/jxq;->executor:Ljava/util/concurrent/ScheduledExecutorService;
...
.method public static deregisterExecutor(Ljava/util/concurrent/ScheduledExecutorService;)V
    ...
    .prologue
    .line 108
    sget-object v0, Lc8/jxq;->EXECUTORS:Ljava/util/concurrent/ConcurrentHashMap;
...
.method static purgeExecutors()V
    ...
    .line 115
    :try_start_0
    sget-object v3, Lc8/jxq;->EXECUTORS:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public static registerExecutor(Ljava/util/concurrent/ScheduledThreadPoolExecutor;)V
    ...
    .line 81
    :goto_0
    sget-object v1, Lc8/jxq;->PURGE:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 87
    new-instance v1, Lc8/ixq;

    invoke-direct {v1}, Lc8/ixq;-><init>()V

    sget v2, Lc8/jxq;->PURGE_FREQUENCY:I

    int-to-long v2, v2

    sget v4, Lc8/jxq;->PURGE_FREQUENCY:I
    ...
    .line 100
    :cond_0
    sget-object v1, Lc8/jxq;->EXECUTORS:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public static tryEnableCancelPolicy(Ljava/util/concurrent/ScheduledExecutorService;)Z
    ...
    .line 139
    sget-boolean v5, Lc8/jxq;->SHOULD_TRY_ENABLE_CANCEL_POLICY:Z
    ...
    .line 145
    sget-object v2, Lc8/jxq;->cachedSetRemoveOnCancelPolicyMethod:Ljava/lang/Object;

    .line 147
    .local v2, "localSetRemoveOnCancelPolicyMethod":Ljava/lang/Object;
    sget-object v5, Lc8/jxq;->SET_REMOVE_ON_CANCEL_POLICY_METHOD_NOT_SUPPORTED:Ljava/lang/Object;
    ...
    .line 152
    invoke-static {p0}, Lc8/jxq;->findSetRemoveOnCancelPolicyMethod(Ljava/util/concurrent/ScheduledExecutorService;)Ljava/lang/reflect/Method;
    ...
    :goto_1
    sput-object v5, Lc8/jxq;->cachedSetRemoveOnCancelPolicyMethod:Ljava/lang/Object;
    ...
    invoke-static {v4, p0, v5}, Lc8/jxq;->_1invoke(Ljava/lang/reflect/Method;Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_0
...
.method public isUnsubscribed()Z
    ...
    .prologue
    .line 292
    iget-boolean v0, p0, Lc8/jxq;->isUnsubscribed:Z
...
.method public schedule(Lc8/hnq;)Lc8/Pmq;
    ...
    invoke-virtual {p0, p1, v0, v1, v2}, Lc8/jxq;->schedule(Lc8/hnq;JLjava/util/concurrent/TimeUnit;)Lc8/Pmq;
...
.method public schedule(Lc8/hnq;JLjava/util/concurrent/TimeUnit;)Lc8/Pmq;
    ...
    :cond_0
    invoke-virtual {p0, p1, p2, p3, p4}, Lc8/jxq;->scheduleActual(Lc8/hnq;JLjava/util/concurrent/TimeUnit;)Lrx/internal/schedulers/ScheduledAction;
...
.method public scheduleActual(Lc8/hnq;JLjava/util/concurrent/TimeUnit;)Lrx/internal/schedulers/ScheduledAction;
    .locals 6
    .param p1, "action"    # Lc8/hnq;
    .param p2, "delayTime"    # J
    .param p4, "unit"    # Ljava/util/concurrent/TimeUnit;
    ...
    .prologue
    .line 239
    invoke-static {p1}, Lc8/WAq;->onScheduledAction(Lc8/hnq;)Lc8/hnq;

    move-result-object v0

    .line 240
    .local v0, "decoratedAction":Lc8/hnq;
    new-instance v2, Lrx/internal/schedulers/ScheduledAction;

    invoke-direct {v2, v0}, Lrx/internal/schedulers/ScheduledAction;-><init>(Lc8/hnq;)V
    ...
    .line 243
    iget-object v3, p0, Lc8/jxq;->executor:Ljava/util/concurrent/ScheduledExecutorService;
...
.method public scheduleActual(Lc8/hnq;JLjava/util/concurrent/TimeUnit;Lc8/SBq;)Lrx/internal/schedulers/ScheduledAction;
    .locals 6
    .param p1, "action"    # Lc8/hnq;
    .param p2, "delayTime"    # J
    .param p4, "unit"    # Ljava/util/concurrent/TimeUnit;
    .param p5, "parent"    # Lc8/SBq;
    ...
    invoke-direct {v2, v0, p5}, Lrx/internal/schedulers/ScheduledAction;-><init>(Lc8/hnq;Lc8/SBq;)V

    .line 254
    .local v2, "run":Lrx/internal/schedulers/ScheduledAction;
    invoke-virtual {p5, v2}, Lc8/SBq;->add(Lc8/Pmq;)V
...
.method public scheduleActual(Lc8/hnq;JLjava/util/concurrent/TimeUnit;Lc8/wyq;)Lrx/internal/schedulers/ScheduledAction;
    .locals 6
    .param p1, "action"    # Lc8/hnq;
    .param p2, "delayTime"    # J
    .param p4, "unit"    # Ljava/util/concurrent/TimeUnit;
    .param p5, "parent"    # Lc8/wyq;
    ...
    invoke-direct {v2, v0, p5}, Lrx/internal/schedulers/ScheduledAction;-><init>(Lc8/hnq;Lc8/wyq;)V

    .line 270
    .local v2, "run":Lrx/internal/schedulers/ScheduledAction;
    invoke-virtual {p5, v2}, Lc8/wyq;->add(Lc8/Pmq;)V
...
.method public unsubscribe()V
    ...
    iput-boolean v0, p0, Lc8/jxq;->isUnsubscribed:Z

    .line 286
    iget-object v0, p0, Lc8/jxq;->executor:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    invoke-static {v0}, Lc8/jxq;->deregisterExecutor(Ljava/util/concurrent/ScheduledExecutorService;)V
