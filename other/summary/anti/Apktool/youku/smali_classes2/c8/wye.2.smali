...
.method public static buildUpon()Lc8/wye;
    .locals 1

    .prologue
    .line 64
    new-instance v0, Lc8/wye;

    invoke-direct {v0}, Lc8/wye;-><init>()V
...
.method private static getNotificationIcon(Landroid/content/Context;)I
    ...
    .prologue
    .line 131
    const-string/jumbo v1, "com_sina_weibo_sdk_weibo_logo"

    const-string/jumbo v2, "drawable"

    invoke-static {p0, v1, v2}, Lc8/wye;->getResourceId(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)I
...
.method private static getResourceId(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)I
    ...
    .line 153
    .end local v3    # "themeResources":Landroid/content/res/Resources;
    :goto_0
    return v4
...
# virtual methods
.method public build(Landroid/content/Context;)Lc8/xye;
    .locals 6
    ...
    .line 102
    iget-object v3, p0, Lc8/wye;->mNotificationPendingIntent:Landroid/app/PendingIntent;
    ...
    .line 103
    iget-object v3, p0, Lc8/wye;->mTickerText:Ljava/lang/String;
    ...
    .line 105
    invoke-static {p1}, Lc8/wye;->getNotificationIcon(Landroid/content/Context;)I
    ...
    .line 108
    iget-object v3, p0, Lc8/wye;->mSoundUri:Landroid/net/Uri;
    ...
    .line 112
    :cond_0
    iget-object v3, p0, Lc8/wye;->mVibrate:[J
    ...
    invoke-static {p1, v3}, Lc8/uye;->getDrawable(Landroid/content/Context;Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    .line 118
    iget-object v3, p0, Lc8/wye;->mNotificationTitle:Ljava/lang/String;
    ...
    .line 119
    iget-object v3, p0, Lc8/wye;->mNotificationContent:Ljava/lang/String;
    ...
    invoke-direct {v3, p1, v2, v4}, Lc8/xye;-><init>(Landroid/content/Context;Landroid/app/Notification;Lc8/vye;)V

    return-object v3
.end method

.method public setNotificationContent(Ljava/lang/String;)Lc8/wye;
    .locals 0
    .param p1, "notificationContent"    # Ljava/lang/String;

    .prologue
    .line 78
    iput-object p1, p0, Lc8/wye;->mNotificationContent:Ljava/lang/String;

    .line 79
    return-object p0
.end method

.method public setNotificationPendingIntent(Landroid/app/PendingIntent;)Lc8/wye;
    .locals 0
    .param p1, "notificationPendingIntent"    # Landroid/app/PendingIntent;

    .prologue
    .line 83
    iput-object p1, p0, Lc8/wye;->mNotificationPendingIntent:Landroid/app/PendingIntent;

    .line 84
    return-object p0
.end method

.method public setNotificationTitle(Ljava/lang/String;)Lc8/wye;
    .locals 0
    .param p1, "notificationTitle"    # Ljava/lang/String;

    .prologue
    .line 73
    iput-object p1, p0, Lc8/wye;->mNotificationTitle:Ljava/lang/String;

    .line 74
    return-object p0
.end method

.method public setSoundUri(Landroid/net/Uri;)Lc8/wye;
    .locals 0
    .param p1, "soundUri"    # Landroid/net/Uri;

    .prologue
    .line 93
    iput-object p1, p0, Lc8/wye;->mSoundUri:Landroid/net/Uri;

    .line 94
    return-object p0
.end method

.method public setTickerText(Ljava/lang/String;)Lc8/wye;
    .locals 0
    .param p1, "tickerText"    # Ljava/lang/String;

    .prologue
    .line 68
    iput-object p1, p0, Lc8/wye;->mTickerText:Ljava/lang/String;

    .line 69
    return-object p0
.end method

.method public setVibrate([J)Lc8/wye;
    .locals 0
    .param p1, "vibrate"    # [J

    .prologue
    .line 88
    iput-object p1, p0, Lc8/wye;->mVibrate:[J
