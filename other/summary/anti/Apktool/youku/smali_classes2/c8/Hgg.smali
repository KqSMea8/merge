...
.method static constructor <clinit>()V
    ...
    sput v0, Lc8/Hgg;->mBackgroundColor:I
...
.method public static generateImage(Landroid/view/View;IILc8/Ggg;)V
    .locals 3
    ...
    .param p2, "backgroundColor"    # I
        ...
        .end annotation
    .end param
    .param p3, "mOnImageSavedCallback"    # Lc8/Ggg;

    .prologue
    .line 53
    sput p2, Lc8/Hgg;->mBackgroundColor:I
    ...
    invoke-virtual {v0}, Lc8/pVf;->getWXWorkThreadManager()Lc8/WXf;
    ...
    invoke-direct {v2, p0, p1, p3}, Lc8/Fgg;-><init>(Landroid/view/View;ILc8/Ggg;)V

    invoke-direct {v1, v2}, Ljava/lang/Thread;-><init>(Ljava/lang/Runnable;)V

    invoke-virtual {v0, v1}, Lc8/WXf;->post(Ljava/lang/Runnable;)V
...
.method public static saveBitmapToGallery(Landroid/content/Context;Landroid/graphics/Bitmap;Lc8/Ggg;)Ljava/lang/String;
    .locals 9
    .param p0, "context"    # Landroid/content/Context;
    .param p1, "bitmap"    # Landroid/graphics/Bitmap;
    .param p2, "mOnImageSavedCallback"    # Lc8/Ggg;
    ...
    invoke-interface {p2, v5}, Lc8/Ggg;->onSaveFailed(Ljava/lang/String;)V
