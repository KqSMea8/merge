...
.method public constructor <init>(Landroid/content/ContentResolver;)V
    ...
    iput-object v0, p0, Lc8/Qjg;->values:Ljava/util/Map;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, Lc8/Qjg;->remove:Ljava/util/Set;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lc8/Qjg;->clear:Z

    iput-object p1, p0, Lc8/Qjg;->cr:Landroid/content/ContentResolver;
...
.method public commit()Z
    ...
    iget-boolean v0, p0, Lc8/Qjg;->clear:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Lc8/Qjg;->cr:Landroid/content/ContentResolver;
    ...
    iput-boolean v2, p0, Lc8/Qjg;->clear:Z

    :cond_0
    iget-object v0, p0, Lc8/Qjg;->remove:Ljava/util/Set;
    ...
    iget-object v5, p0, Lc8/Qjg;->cr:Landroid/content/ContentResolver;

    sget-object v6, Lc8/jig;->CONTENT_URI:Landroid/net/Uri;
    ...
    :cond_1
    iget-object v0, p0, Lc8/Qjg;->values:Ljava/util/Map;
    ...
    iget-object v1, p0, Lc8/Qjg;->cr:Landroid/content/ContentResolver;
