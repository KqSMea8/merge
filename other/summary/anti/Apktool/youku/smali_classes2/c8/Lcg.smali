...
.method public static isKeyboardVisible(Landroid/app/Activity;)Z
    ...
    invoke-static {p0}, Lc8/Lcg;->getActivityRoot(Landroid/app/Activity;)Landroid/view/View;
    ...
    invoke-static {v4}, Lc8/Jgg;->dip2px(F)I
...
.method public static registerKeyboardEventListener(Landroid/app/Activity;Lc8/Jcg;)Lc8/Kcg;
    .locals 6
    .param p0, "activity"    # Landroid/app/Activity;
    .param p1, "listener"    # Lc8/Jcg;
    ...
    .line 67
    :cond_4
    new-instance v2, Lc8/Hcg;

    invoke-direct {v2, v0, p1}, Lc8/Hcg;-><init>(Landroid/view/View;Lc8/Jcg;)V
    ...
    .line 88
    new-instance v4, Lc8/Icg;

    invoke-direct {v4, p0, v2}, Lc8/Icg;-><init>(Landroid/app/Activity;Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;)V
