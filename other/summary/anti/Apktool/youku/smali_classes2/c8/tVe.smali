...
.method static getDeviceInfoModle(Landroid/content/Context;)Ljava/util/Map;
    ...
    invoke-static {p0}, Lc8/sVe;->getIMEI(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v1

    .line 45
    .local v1, "imei":Ljava/lang/String;
    invoke-static {p0}, Lc8/sVe;->getIMSI(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 47
    invoke-static {}, Lc8/WVe;->getModuleImei()Ljava/lang/String;
    ...
    .line 50
    invoke-static {}, Lc8/WVe;->getModuleImsi()Ljava/lang/String;
    ...
    invoke-static {v0, v3, v1}, Lc8/tVe;->putMapWithoutEmptyValue(Ljava/util/Map;Ljava/lang/String;Ljava/lang/String;)V

    .line 53
    const-string/jumbo v3, "D2"

    invoke-static {v0, v3, v2}, Lc8/tVe;->putMapWithoutEmptyValue(Ljava/util/Map;Ljava/lang/String;Ljava/lang/String;)V

    .line 55
    const-string/jumbo v3, "D3"

    invoke-static {p0}, Lc8/sVe;->getWifiMacID(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v4

    invoke-static {v0, v3, v4}, Lc8/tVe;->putMapWithoutEmptyValue(Ljava/util/Map;Ljava/lang/String;Ljava/lang/String;)V

    .line 56
    const-string/jumbo v3, "D4"

    invoke-static {}, Lc8/sVe;->getBluetoothMac()Ljava/lang/String;
    ...
    invoke-static {p0}, Lc8/sVe;->getAndroidID(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {}, Lc8/sVe;->getSerialNum()Ljava/lang/String;
    ...
    invoke-static {p0}, Lc8/sVe;->getSimSerialNum(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {}, Lc8/sVe;->getNandID()Ljava/lang/String;
    ...
    invoke-static {}, Lc8/sVe;->getCPUSerial()Ljava/lang/String;
    ...
    invoke-static {p0}, Lc8/sVe;->getPhoneNumber(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {}, Lc8/sVe;->getCpuCount()Ljava/lang/String;
    ...
    invoke-static {}, Lc8/sVe;->getMaxCpuFreq()Ljava/lang/String;
    ...
    invoke-static {}, Lc8/sVe;->getMemTotalSize()Ljava/lang/String;
    ...
    invoke-static {p0}, Lc8/sVe;->getTotalExternalMemorySize(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lc8/sVe;->getScreenDpi(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lc8/sVe;->getScreenResolution(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lc8/wWe;->getUmidToken(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lc8/sVe;->checkTfCard(Landroid/content/Context;)Z
    ...
    invoke-static {p0, v3}, Lc8/sVe;->checkSensor(Landroid/content/Context;I)Z
    ...
    invoke-static {p0}, Lc8/sVe;->hasFingerprintDevice(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Lc8/sVe;->hasGPSDevice(Landroid/content/Context;)Z
