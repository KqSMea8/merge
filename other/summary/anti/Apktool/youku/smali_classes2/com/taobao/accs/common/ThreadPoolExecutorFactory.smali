...
.method public static getScheduledExecutor()Ljava/util/concurrent/ScheduledThreadPoolExecutor;
    ...
    new-instance v3, Lcom/taobao/accs/common/ThreadPoolExecutorFactory$TBThreadFactory;

    const-string/jumbo v4, "ACCS"

    invoke-direct {v3, v4}, Lcom/taobao/accs/common/ThreadPoolExecutorFactory$TBThreadFactory;-><init>(Ljava/lang/String;)V
